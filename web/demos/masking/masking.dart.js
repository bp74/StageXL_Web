  ...
  moveNext$0: function() {
    ...
    for (t3 = t1.get$_keys(); newIndex < t2;) {
      if (typeof t3 !== "string" && (typeof t3 !== "object" || t3 === null || t3.constructor !== Array && !t3.$isJavaScriptIndexingBehavior()))
        return this.moveNext$0$bailout1(3, t2, t1, t3, newIndex, $.CONSTANT2);
      if (newIndex !== (newIndex | 0))
        throw $.iae(newIndex);
...
$$.FlowerField = {"": "DisplayObjectContainer;_children,_mouseChildren,_tabChildren,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_name,_parent,mask,_tmpMatrix,_tmpMatrixIdentity,_eventListenerLists",
  FlowerField$0: function() {
    var i, t1, bitmap, t2, t3, tween;
    for (i = 0; i < 150; ++i) {
      t1 = $.get$random().nextInt$1(3);
      if (typeof t1 !== "number")
        throw $.iae(t1);
      bitmap = $.Bitmap$($.resource.getBitmapData$1("flower" + $.S(1 + t1)), "auto");
      bitmap.set$pivotX(64);
      bitmap.set$pivotY(64);
      t2 = $.get$random().nextInt$1(812);
      if (typeof t2 !== "number")
        throw $.iae(t2);
      bitmap.set$x(64 + t2);
      t3 = $.get$random().nextInt$1(372);
      if (typeof t3 !== "number")
        throw $.iae(t3);
      bitmap.set$y(64 + t3);
...
$$.Tween = {"": "Object;_displayObject,_transitionFunction,_tweenProperties,_onStart,_onUpdate,_onComplete,_totalTime,_currentTime,_delay,_roundToInt,_started",
  ...
  animate$2: function(property, targetValue) {
    var t1 = $.CONSTANT0.indexOf$1(["x", "y", "pivotX", "pivotY", "scaleX", "scaleY", "rotation", "alpha"], property);
    if (typeof t1 !== "number")
...
$$.EventListenerList = {"": "Object;_eventDispatcher,_liblib3$_eventType,_liblib3$_list",
  ...
  add$2: function(eventListener, useCapture) {
    ...
    $.CONSTANT0.add$1(this._liblib3$_list, $._EventListenerUseCapture$(eventListener, useCapture));
  },
  ...
  remove$2: function(eventListener, useCapture) {
    ...
    for (i = 0; t1 = this._liblib3$_list, i < t1.length; ++i) {
      ...
      if (t1) {
        ...
        $.CONSTANT0.removeAt$1(this._liblib3$_list, i);
        t1 = this._liblib3$_eventType;
        if (typeof t1 !== "string")
...
$$.DisplayObjectContainer = {"": "InteractiveObject;",
    ...
    for (left = (1/0), top = (1/0), right = (-1/0), bottom = (-1/0), i = 0; i < t1; ++i) {
      ...
      if (t2 < left) {
        ...
        if (typeof left !== "number")
          return this.getBoundsTransformed$2$bailout(2, matrix, left, top, right, bottom, t1, i, rectangle, null, returnRectangle);
      }
      t2 = rectangle.get$top();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(3, matrix, left, top, right, bottom, t1, i, rectangle, t2, returnRectangle);
      if (t2 < top) {
        top = rectangle.get$top();
        if (typeof top !== "number")
          return this.getBoundsTransformed$2$bailout(4, matrix, left, top, right, bottom, t1, i, rectangle, null, returnRectangle);
      }
      t2 = rectangle.get$right();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(5, matrix, left, top, right, bottom, t1, i, rectangle, t2, returnRectangle);
      if (t2 > right) {
        right = rectangle.get$right();
        if (typeof right !== "number")
          return this.getBoundsTransformed$2$bailout(6, matrix, left, top, right, bottom, t1, i, rectangle, null, returnRectangle);
      }
      t2 = rectangle.get$bottom();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(7, matrix, left, top, right, bottom, t1, i, rectangle, t2, returnRectangle);
      if (t2 > bottom) {
        bottom = rectangle.get$bottom();
        if (typeof bottom !== "number")
          return this.getBoundsTransformed$2$bailout(8, matrix, left, top, right, bottom, t1, i, null, null, returnRectangle);
      }
    }
  ...
  getBoundsTransformed$2$bailout: function(state0, matrix, left, top, right, bottom, t1, i, rectangle, t2, returnRectangle) {
    switch (state0) {
      case 0:
        if (returnRectangle == null)
          returnRectangle = $.Rectangle$zero();
  ...
  hitTestInput$2: function(localX, localY) {
    ...
    for (i = this._children.length - 1, hit = null; i >= 0; --i) {
      ...
      if (child.get$visible() === true) {
        ...
        t1 = matrix.get$tx();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(2, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, matrix, i, t1);
        deltaX = localX - t1;
        t1 = matrix.get$ty();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(3, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, matrix, i, t1, deltaX);
        deltaY = localY - t1;
        t1 = matrix.get$d();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(4, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, matrix, i, t1, deltaX, deltaY);
        t1 *= deltaX;
        t5 = matrix.get$c();
        if (typeof t5 !== "number")
          return this.hitTestInput$2$bailout(5, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, matrix, i, t1, deltaX, deltaY, t5);
        t1 -= t5 * deltaY;
        t7 = matrix.get$det();
        if (typeof t7 !== "number")
          return this.hitTestInput$2$bailout(6, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, matrix, i, t1, deltaX, deltaY, null, t7);
        t7 = t1 / t7;
        t1 = matrix.get$a();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(7, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, matrix, i, t1, deltaX, deltaY, null, t7);
        t1 *= deltaY;
        t10 = matrix.get$b();
        if (typeof t10 !== "number")
          return this.hitTestInput$2$bailout(8, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, matrix, i, t1, deltaX, null, null, t7, t10);
        t1 -= t10 * deltaX;
        t12 = matrix.get$det();
        if (typeof t12 !== "number")
          return this.hitTestInput$2$bailout(9, localX, localY, $.CONSTANT2, hit, $.CONSTANT2, child, null, i, t1, null, null, null, t7, null, t12);
  ...
  hitTestInput$2$bailout: function(state0, localX, localY, t2, hit, t1, child, matrix, i, t3, deltaX, deltaY, t7, t9, t12, t14) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
$$.Stage = {"": "DisplayObjectContainer;_canvas,_context,_focus,_renderState,_renderMode,_mouseCursor,_mousePosition,_mouseTarget,_mouseButtons,_touches,_mouseEvent,_keyboardEvent,_touchEvent,_onMouseEventHandler,_onTouchEventHandler,_touchEventSubscriptions,_children,_mouseChildren,_tabChildren,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_name,_parent,mask,_tmpMatrix,_tmpMatrixIdentity,_eventListenerLists",
  ...
  _onMultitouchInputModeChanged$1: function(event) {
    $.CONSTANT0.forEach$1(this._touchEventSubscriptions, new $.Stage__onMultitouchInputModeChanged_anon());
    ...
    if (!(t1 == null))
      if (localX >= 0)
        if (localY >= 0) {
          t2 = t1.get$width();
          if (typeof t2 !== "number")
            return this.hitTestInput$2$bailout0(2, localX, localY, $.CONSTANT2, $.CONSTANT2, t2, t1);
          if (localX < t2) {
            t1 = t1.get$height();
            if (typeof t1 !== "number")
              return this.hitTestInput$2$bailout0(3, null, localY, null, $.CONSTANT2, null, t1);
            t1 = localY < t1;
          } else
            t1 = false;
        } else
    ...
    switch (this._frameMode) {
      ...
      case 1:
        ...
        if ($.$$gt(t5, 0) === true && $.$$gt(t6, 0) === true)
          renderState.get$context().drawImage$9(this._liblib3$_element, iLeft, iTop, t5, t6, t3, t4, t5, t6);
        break;
      case 2:
        fLeft = this._frameX;
        fTop = this._frameY;
        ...
        if ($.$$gt(t5, 0) === true && $.$$gt(t6, 0) === true) {
          ...
          renderState.get$context().drawImage$9(this._liblib3$_element, iLeft, iTop, t6, t5, 0, 0, t6, t5);
        }
        break;
    }
  },
...
$$.Mask = {"": "Object;_type,_rectangle,_circle,_points",
  render$1: function(renderState) {
    ...
    switch (this._type) {
      ...
      case 2:
        ...
        for (i = 1; $.CONSTANT4.$lt(i, $.length(this._points)); ++i)
  ...
  Mask$custom$1: function(points) {
    this._type = 2;
    this._points = points;
    if ($.$$lt($.length(this._points), 3) === true)
...
$$.main_anon = {"": "Closure;rectangleMask_0,circleMask_1,customMask_2",
  call$1: function(result) {
    ...
    document.query$1("#mask-none").get$onClick().listen$1(new $.main__anon(flowerField));
    document.query$1("#mask-rectangle").get$onClick().listen$1(new $.main__anon0(this.rectangleMask_0, flowerField));
    document.query$1("#mask-circle").get$onClick().listen$1(new $.main__anon1(this.circleMask_1, flowerField));
    document.query$1("#mask-custom").get$onClick().listen$1(new $.main__anon2(this.customMask_2, flowerField));
    document.query$1("#mask-spin").get$onClick().listen$1(new $.main__anon3(flowerField));
  }
};
...
$$.main__anon0 = {"": "Closure;rectangleMask_4,flowerField_5",
  call$1: function(e) {
...
$$.main__anon1 = {"": "Closure;circleMask_6,flowerField_7",
  call$1: function(e) {
...
$$.main__anon2 = {"": "Closure;customMask_8,flowerField_9",
  call$1: function(e) {
...
$$.main__anon3 = {"": "Closure;flowerField_10",
  call$1: function(e) {
    ...
    $.add($.renderLoop.get$juggler(), rotate);
  }
};
...
$.listInsertRange$bailout = function(state0, receiver, start, length, initialValue) {
  ...
  if (!(initialValue == null))
    for (i = start; i < t2; ++i)
      $.CONSTANT0.$indexSet(receiver, i, initialValue);
  $.CONSTANT0.set$length(receiver, t1);
};
...
$._FutureImpl__FutureImpl$wait = function(futures) {
  ...
  if (t2.get$isEmpty(futures) === true)
    return $.Future_Future$immediate($.CONSTANT25);
  completer = $.Completer_Completer();
...
$.max = function(a, b) {
  if (typeof b === "number") {
    ...
    if (b === 0 && $.CONSTANT22.get$isNegative(a) === true)
      return b;
    return a;
  }
...
$.main = function() {
  ...
  for (i = 0; i < 6; ++i) {
    ...
    starPath.push($.Point$(470 + 200 * Math.cos($.checkNum(a1)), 250 + 200 * Math.sin($.checkNum(a1))));
    starPath.push($.Point$(470 + 100 * Math.cos($.checkNum(a2)), 250 + 100 * Math.sin($.checkNum(a2))));
  }
  ...
  $.resource.load$0().then$1(new $.main_anon(rectangleMask, circleMask, customMask));
};
...
$.TransitionFunction_easeOutBack = function(ratio) {
  ...
  if (typeof t1 !== "number")
    throw $.iae(t1);
  return $.$$add($.$$mul(t2, 2.70158 * t1 + 1.70158), 1);
};
...
$.TransitionFunction_easeInOutBack = function(ratio) {
  ...
  if (t2.$lt(t1, 1) === true) {
    ...
    t3 = $.TransitionFunction_easeOutBack(t2.$sub(t1, 1));
    if (typeof t3 !== "number")
      throw $.iae(t3);
    t4 = 0.5 * t3 + 0.5;
    t1 = t4;
...
$.CONSTANT25 = Isolate.makeConstantList([]);
...
$.CONSTANT23 = new Isolate.$isolateProperties._Random();
$.lazyPort = null;
