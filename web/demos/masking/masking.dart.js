...
$$.FlowerField = {"": "DisplayObjectContainer;_children,_mouseChildren,_tabChildren,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_mask,_name,_parent,_tmpMatrix,_tmpMatrixIdentity,_eventStreams",
  FlowerField$0: function() {
    var i, t1, bitmap, tween;
    for (i = 0; i < 150; ++i) {
      t1 = $.get$random().nextInt$1(3);
      bitmap = $.Bitmap$($.resourceManager.getBitmapData$1("flower" + $.S(1 + t1)), "auto");
      bitmap.set$pivotX(64);
      bitmap.set$pivotY(64);
      bitmap.set$x(64 + $.get$random().nextInt$1(812));
      bitmap.set$y(64 + $.get$random().nextInt$1(372));
...
$$._EventStreamIndex = {"": "Object;_eventStreams,_eventStreamsCount",
  _addEventStream$1: function(eventStream) {
    ...
    t3 = t1.length;
    if (t2 === t3)
      $.CONSTANT0.add$1(t1, eventStream);
    else {
      if (t2 < 0 || t2 >= t3)
        throw $.ioore(t2);
      t1[t2] = eventStream;
  ...
  _dispatchEvent$1: function($event) {
    ...
    for (t1 = this._eventStreams, tail = 0, head = 0; head < eventStreamsCount; ++head) {
      ...
      $event.set$_liblib3$_target(eventStream.get$_liblib3$_target());
      $event.set$_currentTarget(eventStream.get$_liblib3$_target());
      eventStream._dispatchEvent$1($event);
      if (tail !== head) {
        t2 = t1.length;
        if (tail >= t2)
...
$$._EventStream0 = {"": "Stream;_liblib3$_target>,_liblib3$_eventType,_liblib3$_useCapture,_subscriptions,_subscriptionsCount>",
  ...
  listen$4$onDone$onError$unsubscribeOnError: function(onData, onDone, onError, unsubscribeOnError) {
    ...
    if ($.$$eq(this._liblib3$_eventType, "enterFrame") === true && $.$$eq(this._liblib3$_useCapture, false) === true)
...
$$._EventStreamSubscription0 = {"": "StreamSubscription;_eventStream,_liblib3$_onData,_liblib3$_pauseCount,_liblib3$_canceled",
  ...
  resume$0: function() {
    if ($.$$eq(this.get$_liblib3$_paused(), false) === true)
      throw $.$$throw($.StateError$("Subscription is not paused."));
    this._liblib3$_pauseCount = this._liblib3$_pauseCount - 1;
  },
  get$resume: function() {
...
$$.DisplayObjectContainer = {"": "InteractiveObject;",
  addChild$1: function(child) {
    ...
    t2 = this._children;
    if (t1 === true) {
      $.CONSTANT0.removeAt$1(t2, $.CONSTANT0.indexOf$1(t2, child));
      t2.push(child);
    } else
  ...
  addChildAt$2: function(child, index) {
    ...
    if (t1 === true) {
      $.CONSTANT0.removeAt$1(t2, $.CONSTANT0.indexOf$1(t2, child));
      $.CONSTANT0.insertRange$3(t2, index > t2.length ? index - 1 : index, 1, child);
    } else {
      child.removeFromParent$0();
      child._setParent$1(this);
      $.CONSTANT0.insertRange$3(t2, index, 1, child);
  ...
  render$1: function(renderState) {
    ...
    switch (this._type) {
      ...
      case 2:
        ...
        for (i = 1; $.CONSTANT7.$lt(i, $.length(this._points)); ++i)
...
$.max = function(a, b) {
  if (typeof b === "number") {
    ...
    if (b === 0 && $.CONSTANT38.get$isNegative(a) === true)
      return b;
    return a;
  }
...
$.FlowerField$ = function() {
  var t1 = new $.FlowerField($.List_List(0), true, true, false, true, true, 0, 0, 0, 0, 0, 1, 1, 0, null, null, 1, true, null, "", null, null, null, null);
  t1.DisplayObject$0();
  t1.FlowerField$0();
  return t1;
};
...
$.main = function() {
  ...
  t1 = $.ResourceManager$();
  t1.addBitmapData$2("flower1", "../common/images/Flower1.png");
  t1.addBitmapData$2("flower2", "../common/images/Flower2.png");
  t1.addBitmapData$2("flower3", "../common/images/Flower3.png");
  $.resourceManager = t1;
  $.resourceManager.load$0().then$1(new $.main_anon(rectangleMask, circleMask, customMask));
};
...
$.CONSTANT37 = new Isolate.$isolateProperties.EventStreamProvider("click");
