...
$$._EventStreamIndex = {"": "Object;_eventStreams,_eventStreamsCount",
  _addEventStream$1: function(eventStream) {
    ...
    t3 = t2.length;
    if (t1 === t3)
      $.CONSTANT0.add$1(t2, eventStream);
    else {
      if (t1 < 0 || t1 >= t3)
        throw $.ioore(t1);
      t2[t1] = eventStream;
...
$$._EventStream0 = {"": "Stream;_liblib1$_target>,_liblib1$_eventType,_liblib1$_useCapture,_subscriptions,_subscriptionsCount>",
  listen$4$onDone$onError$unsubscribeOnError: function(onData, onDone, onError, unsubscribeOnError) {
    ...
    t3 = t2.length;
    if (t1 === t3)
      $.CONSTANT0.add$1(t2, subscription);
    else {
      if (t1 < 0 || t1 >= t3)
        throw $.ioore(t1);
      t2[t1] = subscription;
  ...
  render$1: function(renderState) {
    ...
    switch (this._type) {
      ...
      case 2:
        ...
        for (i = 1; $.CONSTANT5.$lt(i, $.length(this._points)); ++i)
...
$.max = function(a, b) {
  if (typeof b === "number") {
    ...
    if (b === 0 && $.CONSTANT33.get$isNegative(a) === true)
      return b;
    return a;
  }
...
$.$int = {builtin$cls: '$int'};
$.CONSTANT25 = new Isolate.$isolateProperties.EventStreamProvider("touchleave");
...
$.CONSTANT18 = new Isolate.$isolateProperties.EventStreamProvider0("mouseMove");
$.CONSTANT12 = new Isolate.$isolateProperties.EventStreamProvider0("keyDown");
$.CONSTANT26 = new Isolate.$isolateProperties.EventStreamProvider("touchenter");
$.CONSTANT11 = new Isolate.$isolateProperties.EventStreamProvider("keydown");
$.CONSTANT10 = new Isolate.$isolateProperties.EventStreamProvider0("keyUp");
$.CONSTANT30 = new Isolate.$isolateProperties.EventStreamProvider0("touchEnd");
$.CONSTANT32 = new Isolate.$isolateProperties.EventStreamProvider("click");
$.CONSTANT23 = new Isolate.$isolateProperties.EventStreamProvider("touchcancel");
$.CONSTANT21 = new Isolate.$isolateProperties.EventStreamProvider("mousedown");
$.CONSTANT24 = new Isolate.$isolateProperties.EventStreamProvider0("touchCancel");
$.CONSTANT27 = new Isolate.$isolateProperties.EventStreamProvider("touchmove");
$.CONSTANT20 = new Isolate.$isolateProperties.EventStreamProvider0("mouseUp");
$.CONSTANT34 = new Isolate.$isolateProperties._Random();
$.CONSTANT9 = new Isolate.$isolateProperties.EventStreamProvider("keyup");
$.CONSTANT29 = new Isolate.$isolateProperties.EventStreamProvider("touchend");
...
$.CONSTANT28 = new Isolate.$isolateProperties.EventStreamProvider0("touchMove");
$.CONSTANT31 = new Isolate.$isolateProperties.EventStreamProvider("touchstart");
$.CONSTANT16 = new Isolate.$isolateProperties.EventStreamProvider0("mouseOut");
$.CONSTANT33 = new Isolate.$isolateProperties.JSDouble();
$.CONSTANT13 = new Isolate.$isolateProperties._CustomEventStreamProvider(Isolate.$isolateProperties.Element__determineMouseWheelEventType);
$.CONSTANT8 = new Isolate.$isolateProperties.EventStreamProvider("keypress");
$.CONSTANT14 = new Isolate.$isolateProperties.EventStreamProvider0("mouseWheel");
...
$.CONSTANT22 = new Isolate.$isolateProperties.EventStreamProvider0("mouseDown");
