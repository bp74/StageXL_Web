...
$$.Tween = {"":"Object;_displayObject,_transitionFunction,_tweenProperties,_onStart,_onUpdate,_onComplete,_totalTime,_currentTime,_delay,_roundToInt,_started",
 ...
 animate$2: function(property, targetValue) {
  if ($.eqB($.CONSTANT1.indexOf$1(["x", "y", "pivotX", "pivotY", "scaleX", "scaleY", "rotation", "alpha"], property), -1))
...
$$.DisplayObjectContainer = {"":"InteractiveObject;",
 ...
 getBoundsTransformed$2: function(matrix, returnRectangle) {
  ...
  for (bottom = (-1/0), i = 0, left = (1/0), top$ = (1/0), right = (-1/0); i < t1; ++i) {
    ...
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(1, matrix, bottom, t1, i, left, rectangle, right, t2, top$, returnRectangle);
    if (t2 < left) {
      left = rectangle.get$left();
      if (typeof left !== 'number')
        return this.getBoundsTransformed$2$bailout(2, left, matrix, bottom, t1, i, rectangle, right, top$, returnRectangle);
    }
    t2 = rectangle.get$top();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(3, matrix, left, bottom, t2, t1, i, rectangle, right, top$, returnRectangle);
    if (t2 < top$) {
      top$ = rectangle.get$top();
      if (typeof top$ !== 'number')
        return this.getBoundsTransformed$2$bailout(4, matrix, left, bottom, t1, i, rectangle, right, top$, returnRectangle);
    }
    t2 = rectangle.get$right();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(5, matrix, left, bottom, t1, i, rectangle, right, top$, returnRectangle, t2);
    if (t2 > right) {
      right = rectangle.get$right();
      if (typeof right !== 'number')
        return this.getBoundsTransformed$2$bailout(6, matrix, left, bottom, right, t1, i, rectangle, top$, returnRectangle);
    }
 ...
 hitTestInput$2: function(localX, localY) {
  ...
  for (i = this._children.length - 1, hit = null; i >= 0; --i) {
    ...
    if (child.get$visible() === true) {
      ...
      t1 = matrix.get$d();
      if (typeof t1 !== 'number')
        return this.hitTestInput$2$bailout(4, hit, deltaX, localY, deltaY, t1, child, localX, matrix, i);
      t1 *= deltaX;
      t5 = matrix.get$c();
      if (typeof t5 !== 'number')
        return this.hitTestInput$2$bailout(5, hit, deltaX, localY, deltaY, child, t1, t5, localX, matrix, i);
      t1 -= t5 * deltaY;
      t7 = matrix.get$det();
      if (typeof t7 !== 'number')
        return this.hitTestInput$2$bailout(6, hit, deltaX, localY, deltaY, child, localX, t1, t7, matrix, i);
      childX = t1 / t7;
      t7 = matrix.get$a();
      if (typeof t7 !== 'number')
        return this.hitTestInput$2$bailout(7, hit, deltaX, localY, deltaY, childX, child, localX, matrix, i, t7);
      t7 *= deltaY;
      t9 = matrix.get$b();
      if (typeof t9 !== 'number')
        return this.hitTestInput$2$bailout(8, hit, t7, t9, deltaX, localY, child, localX, matrix, i, childX);
      t7 -= t9 * deltaX;
      t11 = matrix.get$det();
...
$$.MovieClip = {"":"InteractiveObject;_bitmapDatas,_frameRate,_currentFrame,_frameTime,_play,_loop,_progressEvent,_completeEvent,clipRectangle,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_name,_parent,mask,_tmpMatrix,_tmpMatrixIdentity,_eventListenerLists",
 ...
 getBoundsTransformed$2$bailout0: function(state0, matrix, returnRectangle, t1) {
  var bitmapData = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, this._currentFrame);
  return $._getBoundsTransformedHelper(matrix, bitmapData.get$width(), bitmapData.get$height(), returnRectangle);
},
 getBoundsTransformed$1: function(matrix) {
  return this.getBoundsTransformed$2(matrix, null);
 ...
 hitTestInput$2$bailout0: function(state0, env0, env1, env2, env3) {
  ...
  switch (state0) {
    ...
    case 2:
      state0 = 0;
      bitmapData = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, this._currentFrame);
    default:
