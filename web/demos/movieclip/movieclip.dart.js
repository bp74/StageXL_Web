...
$$.DelayedCall = {"":
 ...
 advanceTime$1: function(time) {
  ...
  t1 = this._totalTime;
  if (typeof t1 !== 'number')
    return this.advanceTime$1$bailout(3, t1, newTime, 0);
  while (true) {
    if (newTime >= t1) {
      var t2 = this._repeatCount;
      if (typeof t2 !== 'number')
        return this.advanceTime$1$bailout(4, newTime, t1, t2);
      t2 = t2 > 0;
    } else
      t2 = false;
    if (!t2)
    ...
    if (typeof t2 !== 'number')
      return this.advanceTime$1$bailout(5, newTime, t2, t1);
  ...
  if (typeof t1 !== 'number')
    return this.advanceTime$1$bailout(6, newTime, t1, 0);
  if (t1 === 0)
    return false;
...
$$.Tween = {"":
 ...
 advanceTime$1: function(time) {
  ...
  if (t1 < t3 || !this._started) {
    ...
    if (typeof t1 !== 'number')
      return this.advanceTime$1$bailout(4, t1, t3, 0, 0, 0, 0, 0, 0);
    if (t1 > t3)
    ...
    if (t1 >= 0) {
      ...
      if (typeof transition !== 'number')
        return this.advanceTime$1$bailout(7, transition, t3, 0, 0, 0, 0, 0, 0);
      for (t1 = this._animateProperties, t2 = this._roundToInt, i = 0; t4 = t1.length, i < t4; ++i) {
        ...
        if (typeof t5 !== 'number')
          return this.advanceTime$1$bailout(8, transition, t2, ap, t5, t1, i, t3, 0);
        var t7 = ap.get$targetValue();
        if (typeof t7 !== 'number')
          return this.advanceTime$1$bailout(9, transition, t2, ap, t5, t7, i, t1, t3);
        ...
        if (t2) {
          var t4 = $.round(value);
          if (typeof t4 !== 'number')
            return this.advanceTime$1$bailout(10, t9, transition, t2, t4, t1, i, t5, t3);
        } else
          t4 = value;
      ...
      for (t1 = this._animateValues, i = 0; t4 = t1.length, i < t4; ++i) {
        ...
        if (typeof t5 !== 'number')
          return this.advanceTime$1$bailout(11, transition, t2, av, t5, i, t1, t3, 0);
        t7 = av.get$targetValue();
        if (typeof t7 !== 'number')
          return this.advanceTime$1$bailout(12, transition, t2, av, t5, t7, i, t1, t3);
        value = t5 + transition * (t7 - t5);
        if (t2) {
          t4 = $.round(value);
          if (typeof t4 !== 'number')
            return this.advanceTime$1$bailout(13, transition, t2, t4, av, i, t1, t3, 0);
        } else
          t4 = value;
      ...
      if (!(this._onComplete == null)) {
        t1 = this._currentTime;
        if (typeof t1 !== 'number')
          return this.advanceTime$1$bailout(14, t3, t1, 0, 0, 0, 0, 0, 0);
        t1 = t1 === t3;
      } else
        t1 = false;
      if (t1)
  ...
  t1 = this._currentTime;
  if (typeof t1 !== 'number')
    return this.advanceTime$1$bailout(15, t1, t3, 0, 0, 0, 0, 0, 0);
  return t1 < t3;
  var t2;
},
 advanceTime$1$bailout: function(state, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state) {
    ...
    case 2:
      ...
      var t3 = this._totalTime;
    default:
      if (state === 14 || state === 13 || state === 12 || state === 11 || state === 10 || state === 9 || state === 8 || state === 7 || state === 6 || state === 5 || state === 4 || state === 3 || state === 0 && ($.ltB(t1, t3) || this._started === false))
        switch (state) {
          case 0:
            t1 = this._currentTime;
          case 3:
          ...
          case 5:
            state = 0;
          default:
            if (state === 14 || state === 13 || state === 12 || state === 11 || state === 10 || state === 9 || state === 8 || state === 7 || state === 6 || state === 0 && $.geB(t1, 0))
              switch (state) {
                case 0:
                ...
                case 13:
                  ...
                  if (!(this._onUpdate == null))
                    this._onUpdate$0();
                case 14:
                  if (state === 14 || state === 0 && !(this._onComplete == null))
                    switch (state) {
                      case 0:
                        t1 = this._currentTime;
                      case 14:
...
$$.DisplayObjectContainer = {"":
 ...
 sortChildren$1: function(compareFunction) {
  $.sort(this._children, compareFunction);
},
 getBoundsTransformed$2: function(matrix, returnRectangle) {
  if (returnRectangle == null)
    returnRectangle = $.Rectangle$zero();
...
$$.MovieClip = {"":
 ["_bitmapDatas", "_frameRate", "_currentFrame", "_frameTime", "_play", "_loop", "clipRectangle", "doubleClickEnabled", "mouseEnabled", "tabEnabled", "tabIndex", "_x", "_y", "_pivotX", "_pivotY", "_scaleX", "_scaleY", "_rotation", "_transformationMatrixPrivate", "_transformationMatrixRefresh", "_alpha", "_visible", "_name", "_lib2_parent", "mask", "_tmpMatrix", "_tmpMatrixIdentity", "_eventListenersMap"],
 "super": "InteractiveObject",
 ...
 advanceTime$1: function(time) {
  if (typeof time !== 'number')
    return this.advanceTime$1$bailout(1, time, 0, 0, 0);
  if (!this._play || this._frameTime == null)
    this._frameTime = 0;
  else {
    var t1 = this._frameTime;
    if (typeof t1 !== 'number')
      return this.advanceTime$1$bailout(2, t1, time, 0, 0);
    this._frameTime = t1 + time;
    var t3 = this._frameRate;
    if (typeof t3 !== 'number')
      throw $.iae(t3);
    var frameDuration = 1 / t3;
    t1 = this._loop === true;
    while (true) {
      if (this._play) {
        var t2 = this._frameTime;
        if (typeof t2 !== 'number')
          return this.advanceTime$1$bailout(3, frameDuration, t1, t2, 0);
        t2 = t2 >= frameDuration;
      } else
        t2 = false;
      if (!t2)
      ...
      if (typeof t2 !== 'number')
        return this.advanceTime$1$bailout(4, frameDuration, t1, t2, 0);
      ++t2;
      if (t1) {
        t3 = this.get$totalFrames();
        if (typeof t3 !== 'number')
          return this.advanceTime$1$bailout(5, frameDuration, t1, t2, t3);
        t3 = $.mod(t2, t3);
        t2 = t3;
      } else {
        t3 = this.get$totalFrames();
        if (typeof t3 !== 'number')
          return this.advanceTime$1$bailout(6, frameDuration, t1, t2, t3);
        t2 = $.max(t2, t3 - 1);
      }
      this._currentFrame = t2;
      t2 = this._frameTime;
      if (typeof t2 !== 'number')
        return this.advanceTime$1$bailout(7, t2, frameDuration, t1, 0);
      this._frameTime = t2 - frameDuration;
    }
  }
  return true;
},
 advanceTime$1$bailout: function(state, env0, env1, env2, env3) {
  ...
  switch (state) {
    ...
    case 1:
      state = 0;
    default:
      if (state === 0 && (this._play === false || this._frameTime == null))
        this._frameTime = 0;
      else
        switch (state) {
          case 0:
            ...
            L0:
              while (true)
                switch (state) {
                  case 0:
                  case 3:
                    if (state === 3 || state === 0 && this._play === true)
                      switch (state) {
                        case 0:
                          var t2 = this._frameTime;
                        case 3:
                          state = 0;
                          t2 = $.geB(t2, frameDuration);
                      }
                    else
                      t2 = false;
                    if (!t2)
                  ...
                  case 7:
                    state = 0;
                    this._frameTime = $.sub(t2, frameDuration);
                }
        }
      return true;
  }
 ...
 getBoundsTransformed$2: function(matrix, returnRectangle) {
  ...
  var t3 = this._currentFrame;
  if (t3 !== (t3 | 0))
    throw $.iae(t3);
  if (t3 < 0 || t3 >= t1.length)
    throw $.ioore(t3);
  var bitmapData = t1[t3];
  return $._getBoundsTransformedHelper(matrix, bitmapData.get$width(), bitmapData.get$height(), returnRectangle);
},
 getBoundsTransformed$2$bailout: function(state, matrix, returnRectangle, t1) {
 ...
 hitTestInput$2: function(localX, localY) {
  ...
  var t1 = this._bitmapDatas;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.hitTestInput$2$bailout(2, localX, localY, t1, 0);
  var t3 = this._currentFrame;
  if (t3 !== (t3 | 0))
    throw $.iae(t3);
  if (t3 < 0 || t3 >= t1.length)
  ...
  if (localX >= 0)
    if (localY >= 0) {
      ...
      if (localX < t1) {
        ...
        if (typeof t1 !== 'number')
          return this.hitTestInput$2$bailout(4, localY, t1, 0, 0);
        t1 = localY < t1;
      } else
        t1 = false;
    } else
 ...
 hitTestInput$2$bailout: function(state, env0, env1, env2, env3) {
  ...
  switch (state) {
    ...
    case 2:
      ...
      var bitmapData = $.index(t1, this._currentFrame);
    default:
      if (state === 4 || state === 3 || state === 0 && $.geB(localX, 0))
        switch (state) {
          case 0:
          default:
            if (state === 4 || state === 3 || state === 0 && $.geB(localY, 0))
              switch (state) {
                case 0:
                  t1 = bitmapData.get$width();
                case 3:
                  state = 0;
                case 4:
                  if (state === 4 || state === 0 && $.ltB(localX, t1))
                    switch (state) {
                      case 0:
                        t1 = bitmapData.get$height();
                      case 4:
...
$$.TextureAtlas = {"":
 ...
 getBitmapDatas$1: function(namePrefix) {
  var bitmapDataList = $.ListImplementation_List(null);
...
$.MovieClip$ = function(bitmapDatas, frameRate, loop) {
  var t1 = new $.MovieClip(null, null, null, null, null, null, null, false, true, true, 0, 0, 0, 0, 0, 1, 1, 0, null, null, 1, true, '', null, null, null, null, null);
  t1.DisplayObject$0();
...
$.startWalking = function() {
  var bitmapDatas = $.resource.getTextureAtlas$1('walkTextureAtlas').getBitmapDatas$1('walk');
  var rnd = $.Random_Random(null).nextDouble$0();
  var movieClip = $.MovieClip$(bitmapDatas, 30, true);
  movieClip.set$x(-128);
  ...
  var tween = $.Tween$(movieClip, 5 + (1 - rnd) * 5, $.Transitions_linear);
  tween.animate$2('x', 940);
  tween.set$onComplete(new $.startWalking_anon0(movieClip));
  $.add$1($.Juggler_instance(), movieClip);
  $.add$1($.Juggler_instance(), tween);
  $.Juggler_instance().delayCall$2($.startWalking, 0.2);
};
...
$.CTC36 = 'Cannot insertRange on immutable List.';
...
$.CTC39 = 'Cannot sort immutable List.';
...
$.CTC41 = 'offsetX is only supported on elements';
