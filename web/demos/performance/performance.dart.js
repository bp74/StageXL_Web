...
$$._EventListenerListIndex = {"":
 ...
 dispatchEvent$1: function(event$) {
  ...
  for (i = listsLength; t1 = this._lists, t2 = t1.length, i < t2; ++i) {
    var c0 = c + 1;
    var t3 = t1[i];
    if (c >= t2)
      throw $.ioore(c);
...
$.addFlags = function(amount) {
  for (var i = 0; i < amount; ++i) {
    ...
    if (typeof t2 !== 'number')
      throw $.iae(t2);
    flag.set$y(30 + t2);
    $.add$1($.Juggler_instance(), $.stage.addChild$1(flag));
  }
...
$.CTC34 = 'structured clone of other type';
...
$.CTC49 = 'offsetX is only supported on elements';
