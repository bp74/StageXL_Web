...
$$.Flag = {"": "Bitmap;vx,vy,bitmapData,pixelSnapping,clipRectangle,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_mask,_name,_parent,_tmpMatrix,_tmpMatrixIdentity,_eventStreams",
  advanceTime$1: function(time) {
    ...
    t6 = this.vy;
    if (typeof t6 !== "number")
      return this.advanceTime$1$bailout(5, time, t1, 0, tx, t6);
    if (typeof t1 !== "number")
      return this.advanceTime$1$bailout(4, time, t1, 0, tx);
    ty = t1 + t6 * time;
    if (tx > 910 || tx < 30) {
      t1 = this.vx;
      if (typeof t1 !== "number")
        return this.advanceTime$1$bailout(6, 0, t1, 0, 0, 0, ty);
      this.vx = -t1;
    } else
      this.set$x(tx);
    if (ty > 470 || ty < 30) {
  ...
  advanceTime$1$bailout: function(state0, time, t1, t3, tx, t6, ty) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
      ...
      case 5:
        ...
        t1 = $.getInterceptor$JSNumber(tx);
      case 6:
        if (state0 === 6 || state0 === 0 && (t1.$gt(tx, 910) === true || t1.$lt(tx, 30) === true))
          switch (state0) {
            case 0:
              t1 = this.vx;
            case 6:
          ...
          this.set$x(tx);
        t1 = $.getInterceptor$JSNumber(ty);
      case 7:
        if (state0 === 7 || state0 === 0 && (t1.$gt(ty, 470) === true || t1.$lt(ty, 30) === true))
          switch (state0) {
            case 0:
              t1 = this.vy;
            case 7:
...
$$.Juggler = {"": "Object;_elapsedTime,_animatables,_animatablesCount",
  ...
  advanceTime$1$bailout: function(state0, time, t1, animatablesCount, tail, i) {
    switch (state0) {
      ...
      case 3:
        state0 = 0;
        for (tail = 0, head = 0; $.CONSTANT8.$lt(head, animatablesCount); ++head) {
          t1 = this._animatables;
          if (head >= t1.length)
            throw $.ioore(head);
          animatable = t1[head];
...
$$._EventStreamIndex = {"": "Object;_eventStreams,_eventStreamsCount",
  _addEventStream$1: function(eventStream) {
    ...
    t3 = t2.length;
    if (t1 === t3)
      $.CONSTANT3.add$1(t2, eventStream);
    else {
      if (t1 < 0 || t1 >= t3)
        throw $.ioore(t1);
      t2[t1] = eventStream;
...
$$._EventStream0 = {"": "Stream;_liblib1$_target>,_liblib1$_eventType,_liblib1$_useCapture,_subscriptions,_subscriptionsCount>",
  listen$4$onDone$onError$unsubscribeOnError: function(onData, onDone, onError, unsubscribeOnError) {
    ...
    t3 = t2.length;
    if (t1 === t3)
      $.CONSTANT3.add$1(t2, subscription);
    else {
      if (t1 < 0 || t1 >= t3)
        throw $.ioore(t1);
      t2[t1] = subscription;
    ...
    if (this._transformationMatrixRefresh) {
      ...
      if (t1 === 0) {
        ...
        if (typeof t11 !== "number")
          return this.get$_transformationMatrix$bailout(5, t1, t2, t4, t5, 0, t9, t11);
        if (typeof t4 !== "number")
          return this.get$_transformationMatrix$bailout(6, t1, t2, t4, t5, 0, t9, t11, t4);
        if (typeof t9 !== "number")
          return this.get$_transformationMatrix$bailout(4, t1, t2, t4, t5, 0, t9);
        ...
        t1 = this._scaleX;
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(7, t1, 0, 0, 0, 0, 0, 0, 0, cosR, sinR);
        a = t1 * cosR;
        b = t1 * sinR;
        t1 = this._scaleY;
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(9, t1, 0, 0, 0, 0, 0, 0, 0, cosR, sinR, a, b);
        c = -t1 * sinR;
        d = t1 * cosR;
        t1 = this._x;
        t5 = this._pivotX;
        if (typeof t5 !== "number")
          return this.get$_transformationMatrix$bailout(12, 0, 0, 0, t1, 0, 0, 0, 0, 0, 0, a, b, c, d, t5);
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(11, 0, 0, 0, t1, 0, 0, 0, 0, 0, 0, a, b, c, d);
        t1 -= t5 * a;
        t7 = this._pivotY;
        if (typeof t7 !== "number")
          return this.get$_transformationMatrix$bailout(13, 0, 0, 0, t1, 0, 0, 0, 0, 0, 0, a, b, c, d, 0, t7);
        tx = t1 - t7 * c;
        t1 = this._y;
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(14, 0, 0, 0, t1, 0, 0, 0, 0, 0, 0, a, b, c, d, 0, 0, tx);
    ...
    if ($event.get$captures() === true && !(ancestors == null)) {
      ...
      for (; i >= 0; --i) {
        ...
        if (typeof t2 !== "boolean")
          return this.dispatchEvent$1$bailout1(2, $event, ancestors, t1, $.CONSTANT7, i, t2);
        if (!t2)
  ...
  hitTestInput$2: function(localX, localY) {
    ...
    for (i = this._children.length - 1, hit = null; i >= 0; --i) {
      ...
      if (child.get$visible() === true) {
        ...
        t1 = matrix.get$tx();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout1(2, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, matrix, t1, hit);
        deltaX = localX - t1;
        t1 = matrix.get$ty();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout1(3, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, matrix, t1, hit, deltaX);
        deltaY = localY - t1;
        t1 = matrix.get$d();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout1(4, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, matrix, t1, hit, deltaX, deltaY);
        t1 *= deltaX;
        t5 = matrix.get$c();
        if (typeof t5 !== "number")
          return this.hitTestInput$2$bailout1(5, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, matrix, t1, hit, deltaX, deltaY, t5);
        t1 -= t5 * deltaY;
        t7 = matrix.get$det();
        if (typeof t7 !== "number")
          return this.hitTestInput$2$bailout1(6, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, matrix, t1, hit, deltaX, deltaY, 0, t7);
        childX = t1 / t7;
        t7 = matrix.get$a();
        if (typeof t7 !== "number")
          return this.hitTestInput$2$bailout1(7, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, matrix, 0, hit, deltaX, deltaY, 0, t7, childX);
        t7 *= deltaY;
        t9 = matrix.get$b();
        if (typeof t9 !== "number")
          return this.hitTestInput$2$bailout1(8, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, matrix, 0, hit, deltaX, 0, 0, t7, childX, t9);
        t7 -= t9 * deltaX;
        t11 = matrix.get$det();
        if (typeof t11 !== "number")
          return this.hitTestInput$2$bailout1(9, localX, localY, i, $.CONSTANT7, $.CONSTANT7, child, 0, 0, hit, 0, 0, 0, t7, childX, 0, t11);
    ...
    if (!(t1 == null))
      if (localX >= 0)
        if (localY >= 0) {
          t2 = t1.get$width();
          if (typeof t2 !== "number")
            return this.hitTestInput$2$bailout1(2, localX, localY, $.CONSTANT7, $.CONSTANT7, t2, t1);
          if (localX < t2) {
            t1 = t1.get$height();
            if (typeof t1 !== "number")
              return this.hitTestInput$2$bailout1(3, 0, localY, 0, $.CONSTANT7, 0, t1);
            t1 = localY < t1;
          } else
            t1 = false;
        } else
...
$$.main_anon = {"": "Closure;",
  call$1: function(result) {
    ...
    $.stage.get$onEnterFrame().listen$1($.enterFrameListener);
  }
};
...
$.listInsertRange$bailout = function(state0, receiver, start, $length, initialValue) {
  ...
  if (!(initialValue == null))
    for (i = start; i < t2; ++i)
      $.CONSTANT3.$indexSet(receiver, i, initialValue);
  $.CONSTANT3.set$length(receiver, t1);
};
...
$.dynamicBind = function(obj, $name, methods, $arguments) {
  ...
  if (method == null)
    method = $.lookupDynamicClass(hasOwnPropertyFunction, methods, $.getTypeNameOf($.CONSTANT36));
...
$.dynamicFunction = function($name) {
  ...
  if (!(f == null) && !!f.methods)
    return f.methods;
  methods = {};
  dartMethod = Object.getPrototypeOf($.CONSTANT36)[$name];
  if (!(dartMethod == null))
...
$._FutureImpl__FutureImpl$wait = function(futures) {
  ...
  if (t2.get$isEmpty(futures) === true)
    return $._FutureImpl$immediate($.CONSTANT37);
  completer = $._CompleterImpl$();
...
$.enterFrameListener.call$1 = $.enterFrameListener;
$.enterFrameListener.$name = "enterFrameListener";
...
$.CONSTANT37 = Isolate.makeConstantList([]);
$.CONSTANT36 = new Isolate.$isolateProperties.Object();
...
$.CONSTANT34 = new Isolate.$isolateProperties.EventStreamProvider("click");
...
$.CONSTANT35 = new Isolate.$isolateProperties._Random();
$.CONSTANT9 = new Isolate.$isolateProperties.EventStreamProvider("keypress");
$.CONSTANT33 = new Isolate.$isolateProperties.EventStreamProvider0("enterFrame");
