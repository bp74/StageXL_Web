...
$$.ListQueue = {"": "Collection;_table>,_head,_tail,_modificationCount>",
  ...
  _remove$1: function(offset) {
    ...
    t5 = this._tail;
    if (t5 !== (t5 | 0))
      return this._remove$1$bailout(3, offset, mask, 0, $.CONSTANT11, t5, startDistance);
...
$$._HashTable = {"": "Object;_table>,_capacity,_entryCount,_deletedCount,_modificationCount>,_container",
  ...
  _clear$0: function() {
    ...
    if ($.$$eq(this.get$_elementCount(), 0) === true)
      return;
    for (var i = 0; $.CONSTANT11.$lt(i, $.length(this._table)); ++i)
...
$$.HashSet = {"": "Collection;_table>",
  ...
  removeAll$1: function(objectsToRemove) {
    var t1, t2;
    for (t1 = $.CONSTANT5.get$iterator(objectsToRemove), t2 = this._table; t1.moveNext$0() === true;) {
...
$$._LinkedHashTable = {"": "_HashTable;",
  ...
  _clear$0: function() {
    ...
    for (; $.CONSTANT9.$lt(i, $.length(this._table)); ++i)
      $.$$indexSet(this._table, i, null);
    this._deletedCount = 0;
    this._entryCount = 0;
    this._recordModification$0();
...
$$.Flag = {"": "Bitmap;vx,vy,bitmapData,pixelSnapping,clipRectangle,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_mask,_name,_parent,_tmpMatrix,_tmpMatrixIdentity,_eventStreams",
  ...
  advanceTime$1$bailout: function(state0, time, t1, tx) {
    switch (state0) {
      ...
      case 1:
        state0 = 0;
        tx = $.$$add(t1, this.vx * time);
        t1 = this.get$y();
      case 2:
        var ty;
        state0 = 0;
        ty = $.$$add(t1, this.vy * time);
...
$$._EventStreamSubscription = {"": "StreamSubscription;_pauseCount,_target,_eventType,_onData,_useCapture",
  cancel$0: function() {
    if (this.get$_liblib4$_canceled() === true)
      throw $.$$throw($.StateError$("Subscription has been canceled."));
    var t1 = this._onData;
    if (!(t1 == null))
...
$$.Juggler = {"": "Object;_animatables,_animatablesCount,_elapsedTime",
  ...
  advanceTime$1$bailout: function(state0, time, t1, animatablesCount, tail, t2, head) {
    switch (state0) {
      ...
      case 2:
        state0 = 0;
        for (t1 = this._animatables, tail = 0, head = 0; $.CONSTANT11.$lt(head, animatablesCount); ++head) {
          if (head >= t1.length)
            throw $.ioore(head);
          animatable = t1[head];
          if (animatable == null)
...
$$._EventStreamIndex = {"": "Object;_eventStreams,_eventStreamsCount",
  ...
  _dispatchEvent$1: function($event) {
    ...
    for (t1 = this._eventStreams, tail = 0, head = 0; head < eventStreamsCount; ++head) {
      ...
      $event.set$_liblib2$_target(eventStream.get$_liblib2$_target());
      $event.set$_currentTarget(eventStream.get$_liblib2$_target());
      eventStream._dispatchEvent$1($event);
      if (tail !== head) {
        t2 = t1.length;
        if (tail >= t2)
...
$.IterableMixinWorkaround_removeAll = function(collection, elementsToRemove) {
  var t1, t2;
  for (t1 = $.CONSTANT5.get$iterator(elementsToRemove), t2 = $.getInterceptor$JSArray(collection); t1.moveNext$0() === true;)
    t2.remove$1(collection, t1.get$current());
};

$.IterableMixinWorkaround_removeAllList = function(collection, elementsToRemove) {
  collection.removeMatching$1($.contains0($.CONSTANT5.toSet$0(elementsToRemove)));
};
...
$.addFlags = function(amount) {
  var flagIndex, flagName, flag, t1;
  for (; --amount, amount >= 0;) {
    flagIndex = $.get$random().nextInt$1($.length($.textureAtlas.get$frameNames()));
    flagName = $.$$index($.textureAtlas.get$frameNames(), flagIndex);
    flag = $.Flag$($.textureAtlas.getBitmapData$1(flagName), $.get$random().nextInt$1(200) - 100, $.get$random().nextInt$1(200) - 100);
    flag.set$x(30 + $.get$random().nextInt$1(880));
    flag.set$y(30 + $.get$random().nextInt$1(440));
    flag.addTo$1($.stage);
    $.add($.juggler, flag);
  }
...
$.CONSTANT32 = new Isolate.$isolateProperties.EventStreamProvider0("mouseMove");
$.CONSTANT34 = new Isolate.$isolateProperties.EventStreamProvider0("mouseUp");
...
$.CONSTANT37 = new Isolate.$isolateProperties.EventStreamProvider0("enterFrame");
$.CONSTANT35 = new Isolate.$isolateProperties.EventStreamProvider("mousedown");
...
$.CONSTANT38 = new Isolate.$isolateProperties.EventStreamProvider("click");
$.CONSTANT17 = new Isolate.$isolateProperties.EventStreamProvider("touchcancel");
$.CONSTANT39 = new Isolate.$isolateProperties._Random();
...
$.CONSTANT36 = new Isolate.$isolateProperties.EventStreamProvider0("mouseDown");
...
$.CONSTANT28 = new Isolate.$isolateProperties.EventStreamProvider0("mouseWheel");
$.CONSTANT29 = new Isolate.$isolateProperties.EventStreamProvider("mouseout");
$.CONSTANT33 = new Isolate.$isolateProperties.EventStreamProvider("mouseup");
$.CONSTANT31 = new Isolate.$isolateProperties.EventStreamProvider("mousemove");
$.CONSTANT30 = new Isolate.$isolateProperties.EventStreamProvider0("mouseOut");
...
$.$defineNativeClass("HTMLInputElement", {"": "height=,name>,pattern>,src<,type>,width=",
  $isElement: function() {
    return true;
  },
  $asElement: function() {
