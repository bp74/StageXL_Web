    ...
    switch (state0) {
      ...
      case 2:
        ...
        if (t2 == null)
          ...
          t3 = $.toString(t1.sb_0);
          t1.sb_0 = $.StringBuffer_StringBuffer("");
          for (t4 = $.getInterceptor$JSArrayJSString(t2), i = 0; $.CONSTANT6.$lt(i, t4.get$length(t2)); ++i) {
            if (i > 0)
              $.add(t1.sb_0, ", ");
...
$$._StringBufferImpl = {"": "Object;_buffer,_liblib1$_length",
  ...
  add$1: function(obj) {
    ...
    if ($.CONSTANT3.get$isEmpty(t1) === true)
      return;
    $.add(this._buffer, t1);
    ...
    this._liblib1$_length = t2 + t4;
  },
  add$1$bailout0: function(state0, t1, t2) {
    this._liblib1$_length = $.$$add(t2, t1.length);
  },
  ...
  _deserializeMap$1$bailout: function(state0, x, result, keys, t1, values, t3, len) {
    switch (state0) {
      ...
      case 3:
        var id, t2, i;
        state0 = 0;
        for (t1 = $.getInterceptor$JSArrayJSString(values), t2 = $.getInterceptor$JSArray(result), i = 0; $.CONSTANT6.$lt(i, len); ++i)
...
$$.Flag = {"": "Bitmap;vx,vy,bitmapData,pixelSnapping,clipRectangle,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_name,_parent,mask,_tmpMatrix,_tmpMatrixIdentity,_eventListenerLists",
  advanceTime$1: function(time) {
    ...
    t7 = this.vy;
    if (typeof t7 !== "number")
      return this.advanceTime$1$bailout0(5, time, t1, null, t5, t7);
    if (typeof t5 !== "number")
      return this.advanceTime$1$bailout0(4, time, t1, null, t5);
    t5 += t7 * time;
    if (t1 > 910 || t1 < 30) {
      t1 = this.vx;
      if (typeof t1 !== "number")
        return this.advanceTime$1$bailout0(6, null, t1, null, t5);
      this.vx = -t1;
    } else
      this.set$x(t1);
    if (t5 > 470 || t5 < 30) {
      t1 = this.vy;
      if (typeof t1 !== "number")
        return this.advanceTime$1$bailout0(7, null, t1);
      this.vy = -t1;
    } else
      this.set$y(t5);
    return true;
  },
  advanceTime$1$bailout0: function(state0, time, t1, t3, t5, t7) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
      ...
      case 5:
        state0 = 0;
        t5 = $.$$add(t5, $.$$mul(t7, time));
        t2 = $.getInterceptor$JSNumber(t1);
      case 6:
        if (state0 === 6 || state0 === 0 && (t2.$gt(t1, 910) === true || t2.$lt(t1, 30) === true))
          switch (state0) {
            case 0:
              t1 = this.vx;
            case 6:
      ...
      case 7:
        var t2;
        if (state0 === 7 || state0 === 0 && (t1.$gt(t5, 470) === true || t1.$lt(t5, 30) === true))
          switch (state0) {
            case 0:
              t1 = this.vy;
            case 7:
...
$$._ChildrenElementList = {"": "Object;_liblib4$_element,_childElements",
  ...
  removeLast$0: function() {
    var t1 = $.last(this);
    if (!(t1 == null))
      this._liblib4$_element.$$dom_removeChild$1(t1);
    return t1;
  },
  get$last: function() {
...
$$._FrozenElementListIterator = {"": "Object;_liblib4$_list,_liblib4$_index,_current",
  moveNext$0: function() {
    ...
    if (t1 < t4) {
      ...
      this._liblib4$_index = t1;
      return true;
    }
    this._liblib4$_index = t3.get$length(t2);
    this._current = null;
    return false;
  },
      ...
      default:
        if (state0 === 3 || state0 === 0 && t4.$eq($char, 48) === true)
          switch (state0) {
            ...
            case 3:
              state0 = 0;
              if ($.CONSTANT6.$le(48, t4) && $.$$le(t4, 57) === true)
                this.fail$1(position);
              $char = t4;
          }
        else
...
$$.Juggler = {"": "Object;_animatables,_animatablesCount,_elapsedTime",
  ...
  remove$1: function(animatable) {
    ...
    if (animatable == null)
      return;
    for (i = 0; $.CONSTANT6.$lt(i, this._animatablesCount); ++i) {
  ...
  advanceTime$1$bailout: function(state0, time, t1, animatablesCount, i, c) {
    switch (state0) {
      ...
      case 3:
        state0 = 0;
        for (i = 0, c = 0; $.CONSTANT6.$lt(i, animatablesCount); ++i) {
          t1 = this._animatables;
          if (i >= t1.length)
            throw $.ioore(i);
          animatable = t1[i];
...
$$.EventListenerList = {"": "Object;_eventDispatcher,_liblib3$_eventType,_liblib3$_list",
  ...
  add$2: function(eventListener, useCapture) {
    ...
    $.CONSTANT2.add$1(this._liblib3$_list, $._EventListenerUseCapture$(eventListener, useCapture));
  },
  ...
  remove$2: function(eventListener, useCapture) {
    ...
    for (i = 0; t1 = this._liblib3$_list, i < t1.length; ++i) {
      ...
      if (t1) {
        ...
        $.CONSTANT2.removeAt$1(this._liblib3$_list, i);
        t1 = this._liblib3$_eventType;
        if (typeof t1 !== "string")
...
$$._EventListenerListIndex = {"": "Object;_lists",
  ...
  remove$1: function(list) {
    var index, t1;
    index = $.CONSTANT2.indexOf$1(this._lists, list);
    if ($.$$eq(index, -1) !== true) {
      t1 = this._lists;
      if (index !== (index | 0))
        throw $.iae(index);
...
$$.DisplayObject = {"": "EventDispatcher;_alpha>,_parent>,mask>",
  ...
  get$_transformationMatrix: function() {
    ...
    if (this._transformationMatrixRefresh) {
      ...
      if (t1 === 0) {
        ...
        t2 = this._scaleX;
        if (typeof t2 !== "number")
          return this.get$_transformationMatrix$bailout(1, t1, t2);
        t4 = this._scaleY;
        t5 = this._x;
        t7 = this._pivotX;
        if (typeof t7 !== "number")
          return this.get$_transformationMatrix$bailout(3, t1, t2, t4, t5, t7);
        if (typeof t5 !== "number")
          return this.get$_transformationMatrix$bailout(2, t1, t2, t4, t5);
        t5 -= t7 * t2;
        t9 = this._y;
        t11 = this._pivotY;
        if (typeof t11 !== "number")
          return this.get$_transformationMatrix$bailout(5, t1, t2, t4, t5, null, t9, t11);
        if (typeof t4 !== "number")
          return this.get$_transformationMatrix$bailout(6, t1, t2, t4, t5, null, t9, t11, t4);
        if (typeof t9 !== "number")
          return this.get$_transformationMatrix$bailout(4, t1, t2, t4, t5, null, t9);
        ...
        t1 = this._scaleX;
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(7, t1, null, null, null, null, null, null, null, cosR, sinR);
        t3 = t1 * cosR;
        t1 *= sinR;
        t4 = this._scaleY;
        if (typeof t4 !== "number")
          return this.get$_transformationMatrix$bailout(9, t3, null, null, t4, null, null, null, null, cosR, sinR, t1);
        t6 = -t4 * sinR;
        t4 *= cosR;
        t7 = this._x;
        t9 = this._pivotX;
        if (typeof t9 !== "number")
          return this.get$_transformationMatrix$bailout(12, t3, null, null, null, t6, null, null, null, null, null, t1, t4, t7, t9);
        if (typeof t7 !== "number")
          return this.get$_transformationMatrix$bailout(11, t3, null, null, null, t6, null, null, null, null, null, t1, t4, t7);
        t7 -= t9 * t3;
        t11 = this._pivotY;
        if (typeof t11 !== "number")
          return this.get$_transformationMatrix$bailout(13, t3, null, null, null, t6, null, null, null, null, null, t1, t4, t7, null, t11);
        t7 -= t11 * t6;
        t13 = this._y;
        if (typeof t13 !== "number")
          return this.get$_transformationMatrix$bailout(14, t3, null, null, null, t6, null, null, null, null, null, t1, t4, t7, null, null, t13);
  ...
  get$_transformationMatrix$bailout: function(state0, t1, t2, t4, t5, t7, t9, t11, t13, cosR, sinR, t3, t8, t10, t12, t14, t16, t18, t20) {
    switch (state0) {
      case 0:
      default:
        if (state0 === 16 || state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 2 || state0 === 1 || state0 === 0 && this._transformationMatrixRefresh)
          switch (state0) {
            case 0:
              this._transformationMatrixRefresh = false;
              t1 = this._rotation;
            default:
              if (state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 2 || state0 === 1 || state0 === 0 && t1 === 0)
                switch (state0) {
                  case 0:
                    t1 = this._transformationMatrixPrivate;
                    t2 = this._scaleX;
    ...
    if (event.get$captures() === true && !(ancestors == null)) {
      ...
      for (; i >= 0; --i) {
        ...
        if (typeof t2 !== "boolean")
          return this.dispatchEvent$1$bailout(2, event, ancestors, t1, $.CONSTANT4, i, t2);
        if (!t2)
...
$$.DisplayObjectContainer = {"": "InteractiveObject;",
  ...
  addChild$1: function(child) {
    ...
    t2 = this._children;
    if (t1 === true) {
      index = $.CONSTANT2.indexOf$1(t2, child);
      $.CONSTANT2.removeAt$1(this._children, index);
  ...
  addChildAt$2: function(child, index) {
    ...
    if ($.$$eq(child.get$parent(), this) === true) {
      t1 = this._children;
      $.CONSTANT2.removeAt$1(t1, $.CONSTANT2.indexOf$1(t1, child));
      t1 = this._children;
      $.CONSTANT2.insertRange$3(t1, index > t1.length ? index - 1 : index, 1, child);
    } else {
      child.removeFromParent$0();
      child._setParent$1(this);
      $.CONSTANT2.insertRange$3(this._children, index, 1, child);
  ...
  removeChild$1: function(child) {
    var childIndex = $.CONSTANT2.indexOf$1(this._children, child);
    ...
    for (top = (1/0), right = (-1/0), bottom = (-1/0), i = 0, left = (1/0); i < t1; ++i) {
      ...
      if (t2 < left) {
        ...
        if (typeof left !== "number")
          return this.getBoundsTransformed$2$bailout(2, matrix, top, right, t1, bottom, i, rectangle, left, null, returnRectangle);
      }
      t2 = rectangle.get$top();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(3, matrix, top, right, t1, bottom, i, rectangle, left, t2, returnRectangle);
      if (t2 < top) {
        top = rectangle.get$top();
        if (typeof top !== "number")
          return this.getBoundsTransformed$2$bailout(4, matrix, top, right, t1, bottom, i, rectangle, left, null, returnRectangle);
      }
      t2 = rectangle.get$right();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(5, matrix, top, right, t1, bottom, i, rectangle, left, t2, returnRectangle);
      if (t2 > right) {
        right = rectangle.get$right();
        if (typeof right !== "number")
          return this.getBoundsTransformed$2$bailout(6, matrix, top, right, t1, bottom, i, rectangle, left, null, returnRectangle);
      }
      t2 = rectangle.get$bottom();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(7, matrix, top, right, t1, bottom, i, rectangle, left, t2, returnRectangle);
      if (t2 > bottom) {
        bottom = rectangle.get$bottom();
        if (typeof bottom !== "number")
          return this.getBoundsTransformed$2$bailout(8, matrix, top, right, t1, bottom, i, null, left, null, returnRectangle);
      }
    }
  ...
  getBoundsTransformed$2$bailout: function(state0, matrix, top, right, t1, bottom, i, rectangle, left, t2, returnRectangle) {
    switch (state0) {
      case 0:
        if (returnRectangle == null)
          returnRectangle = $.Rectangle$zero();
  ...
  hitTestInput$2: function(localX, localY) {
    ...
    for (i = this._children.length - 1, hit = null; i >= 0; --i) {
      ...
      if (child.get$visible() === true) {
        ...
        t1 = matrix.get$tx();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(2, localX, localY, $.CONSTANT4, matrix, $.CONSTANT4, child, hit, t1, i);
        deltaX = localX - t1;
        t1 = matrix.get$ty();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(3, localX, localY, $.CONSTANT4, matrix, $.CONSTANT4, child, hit, t1, i, deltaX);
        deltaY = localY - t1;
        t1 = matrix.get$d();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(4, localX, localY, $.CONSTANT4, matrix, $.CONSTANT4, child, hit, t1, i, deltaX, deltaY);
        t1 *= deltaX;
        t5 = matrix.get$c();
        if (typeof t5 !== "number")
          return this.hitTestInput$2$bailout(5, localX, localY, $.CONSTANT4, matrix, $.CONSTANT4, child, hit, t1, i, deltaX, deltaY, t5);
        t1 -= t5 * deltaY;
        t7 = matrix.get$det();
        if (typeof t7 !== "number")
          return this.hitTestInput$2$bailout(6, localX, localY, $.CONSTANT4, matrix, $.CONSTANT4, child, hit, t1, i, deltaX, deltaY, null, t7);
        t7 = t1 / t7;
        t1 = matrix.get$a();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(7, localX, localY, $.CONSTANT4, matrix, $.CONSTANT4, child, hit, t1, i, deltaX, deltaY, null, t7);
        t1 *= deltaY;
        t10 = matrix.get$b();
        if (typeof t10 !== "number")
          return this.hitTestInput$2$bailout(8, localX, localY, $.CONSTANT4, matrix, $.CONSTANT4, child, hit, t1, i, deltaX, null, null, t7, t10);
        t1 -= t10 * deltaX;
        t12 = matrix.get$det();
        if (typeof t12 !== "number")
          return this.hitTestInput$2$bailout(9, localX, localY, $.CONSTANT4, null, $.CONSTANT4, child, hit, t1, i, null, null, null, t7, null, t12);
  ...
  hitTestInput$2$bailout: function(state0, localX, localY, t2, matrix, t1, child, hit, t3, i, deltaX, deltaY, t7, t9, t12, t14) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
$$.Stage = {"": "DisplayObjectContainer;_canvas,_context,_focus,_renderState,_renderMode,_mouseCursor,_mousePosition,_mouseTarget,_mouseButtons,_touches,_mouseEvent,_keyboardEvent,_touchEvent,_onMouseEventHandler,_onTouchEventHandler,_touchEventSubscriptions,_children,_mouseChildren,_tabChildren,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_name,_parent,mask,_tmpMatrix,_tmpMatrixIdentity,_eventListenerLists",
  ...
  _onMultitouchInputModeChanged$1: function(event) {
    $.CONSTANT2.forEach$1(this._touchEventSubscriptions, new $.Stage__onMultitouchInputModeChanged_anon());
    ...
    if (!(t1 == null))
      if (localX >= 0)
        if (localY >= 0) {
          t2 = t1.get$width();
          if (typeof t2 !== "number")
            return this.hitTestInput$2$bailout0(2, localX, localY, $.CONSTANT4, $.CONSTANT4, t2, t1);
          if (localX < t2) {
            t1 = t1.get$height();
            if (typeof t1 !== "number")
              return this.hitTestInput$2$bailout0(3, null, localY, null, $.CONSTANT4, null, t1);
            t1 = localY < t1;
          } else
            t1 = false;
        } else
...
$$.main_anon = {"": "Closure;",
  call$1: function(result) {
    $.textureAtlas = result;
    $.addFlags(250);
    document.query$1("#minus10").get$onClick().listen$1(new $.main__anon());
    document.query$1("#minus50").get$onClick().listen$1(new $.main__anon0());
    document.query$1("#plus50").get$onClick().listen$1(new $.main__anon1());
    document.query$1("#plus10").get$onClick().listen$1(new $.main__anon2());
  ...
  if (radix == null) {
    ...
    if (!(match == null)) {
      ...
      if (radix < 10 || t1.$index(match, 3) == null) {
        ...
        for (t1 = $.getInterceptor$JSArrayJSString(t2), i = 0; $.CONSTANT6.$lt(i, t1.get$length(t2)); ++i)
...
$.listInsertRange$bailout = function(state0, receiver, start, length, initialValue) {
  ...
  if (!(initialValue == null))
    for (i = start; i < t2; ++i)
      $.CONSTANT2.$indexSet(receiver, i, initialValue);
  $.CONSTANT2.set$length(receiver, t1);
};
...
$.IterableMixinWorkaround_removeAllList = function(collection, elementsToRemove) {
  $.removeMatching(collection, $.contains($.CONSTANT2.toSet$0(elementsToRemove)));
};
...
$.addFlags = function(amount) {
  var flagIndex, t1, flag, t2, t3;
  for (; --amount, amount >= 0;) {
    flagIndex = $.get$random().nextInt$1($.length($.textureAtlas.get$frameNames()));
    t1 = $.$$index($.textureAtlas.get$frameNames(), flagIndex);
    flag = $.Flag$($.textureAtlas.getBitmapData$1(t1), $.$$sub($.get$random().nextInt$1(200), 100), $.$$sub($.get$random().nextInt$1(200), 100));
    t2 = $.get$random().nextInt$1(880);
    if (typeof t2 !== "number")
      throw $.iae(t2);
    flag.set$x(30 + t2);
  ...
  document.query$1("#spriteCounter").set$innerHtml(t1);
};
...
$.removeFlags = function(amount) {
  ...
  while (true) {
    --amount;
    t1 = amount >= 0 && $.$$gt($.stage.get$numChildren(), 0) === true;
    t2 = $.stage;
    if (!t1)
      break;
    displayObject = t2.getChildAt$1(0);
    displayObject.removeFromParent$0();
    $.remove($.juggler, displayObject);
  }
...
$._getBoundsTransformedHelper = function(matrix, width, height, returnRectangle) {
  ...
  left0 = $.CONSTANT6.$gt(0, x2) ? x2 : 0;
  if ($.$$gt(left0, left) === true)
    left0 = left;
  if ($.$$gt(left0, x4) === true)
    left0 = x4;
  top0 = $.CONSTANT6.$gt(0, y2) ? y2 : 0;
  if ($.$$gt(top0, top) === true)
    top0 = top;
  if ($.$$gt(top0, y4) === true)
    top0 = y4;
  right = $.CONSTANT6.$lt(0, x2) ? x2 : 0;
  if ($.$$lt(right, left) === true)
    right = left;
  if ($.$$lt(right, x4) === true)
    right = x4;
  bottom = $.CONSTANT6.$lt(0, y2) ? y2 : 0;
...
$.Element_clickEvent = Isolate.$isolateProperties.CONSTANT21;
