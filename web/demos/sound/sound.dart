    ...
    if (this.noteIndex < notes.length) {
      for(int i = 0; i < this.numChildren; i++) {
        ...
        if (displayObject is PianoKey) {
          if (displayObject.noteName == notes[noteIndex]) {
      ...
      Tween tweenY = new Tween(this.noteFinger, 0.4, Transitions.linear);
