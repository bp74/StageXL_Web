...
$$.Juggler = {"":"Object;_animatables,_animatablesCount,_elapsedTime",
 ...
 advanceTime$1: function(time) {
  ...
  while (true) {
    ...
    if (typeof t3 !== 'number')
      return this.advanceTime$1$bailout(4, t3, c, i);
    if (!(i < t3))
      break;
    c0 = c + 1;
    if (i < 0 || i >= t2)
...
$$.DisplayObjectContainer = {"":"InteractiveObject;",
 ...
 getBoundsTransformed$2: function(matrix, returnRectangle) {
  ...
  for (i = 0, left = (1/0), top$ = (1/0), right = (-1/0), bottom = (-1/0); i < t1; ++i) {
    ...
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(1, matrix, i, left, top$, right, bottom, rectangle, t2, returnRectangle, t1);
    if (t2 < left) {
      left = rectangle.get$left();
      if (typeof left !== 'number')
        return this.getBoundsTransformed$2$bailout(2, left, matrix, i, top$, right, bottom, rectangle, t1, returnRectangle);
    }
    t2 = rectangle.get$top();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(3, matrix, left, i, top$, right, bottom, rectangle, t2, returnRectangle, t1);
    if (t2 < top$) {
      top$ = rectangle.get$top();
      if (typeof top$ !== 'number')
        return this.getBoundsTransformed$2$bailout(4, matrix, left, i, t1, right, bottom, rectangle, top$, returnRectangle);
    }
    t2 = rectangle.get$right();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(5, matrix, left, i, t1, right, bottom, rectangle, top$, returnRectangle, t2);
    if (t2 > right) {
      right = rectangle.get$right();
      if (typeof right !== 'number')
        return this.getBoundsTransformed$2$bailout(6, matrix, left, i, right, t1, bottom, rectangle, top$, returnRectangle);
    }
    t2 = rectangle.get$bottom();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(7, matrix, left, i, t1, right, bottom, rectangle, t2, top$, returnRectangle);
    if (t2 > bottom) {
