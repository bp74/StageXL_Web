...
$$._EventStreamSubscription = {"": "StreamSubscription;_pauseCount,_liblib3$_target,_eventType,_onData,_useCapture",
  cancel$0: function() {
    ...
    var t1 = this._onData;
    if (!(t1 == null))
      this._liblib3$_target.$$dom_removeEventListener$3(this._eventType, t1, this._useCapture);
  ...
  _tryResume$0: function() {
    if (!(this._onData == null) && this.get$_paused() !== true)
      this._liblib3$_target.$$dom_addEventListener$3(this._eventType, this._onData, this._useCapture);
  },
...
$$.DisplayObject = {"": "EventDispatcher;_alpha>,_parent>,mask>",
  ...
  get$_transformationMatrix: function() {
    var t1, t2, t3, t4, t5, t6, t8, cosR, sinR, a, b, c, d, t7;
    if (this._transformationMatrixRefresh) {
      ...
      if (t1 === 0) {
        ...
        t1 = this._scaleX;
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(3, t1, t3, null, null, null, t2, null, cosR, sinR);
        a = t1 * cosR;
        b = t1 * sinR;
        t1 = this._scaleY;
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(5, a, t3, null, b, null, t2, null, cosR, sinR, t1);
        c = -t1 * sinR;
        d = t1 * cosR;
        t1 = this._x;
        if (typeof t1 !== "number")
          return this.get$_transformationMatrix$bailout(7, a, t3, null, b, null, t2, null, null, null, null, c, d, t1);
        t7 = t1 - t2 * a - t3 * c;
        t8 = this._y;
        if (typeof t8 !== "number")
          return this.get$_transformationMatrix$bailout(8, a, t3, null, b, null, t2, null, null, null, null, c, d, t7, t8);
        this._transformationMatrixPrivate.setTo$6(a, b, c, d, t7, t8 - t2 * b - t3 * d);
      }
    }
    return this._transformationMatrixPrivate;
  },
  get$_transformationMatrix$bailout: function(state0, t1, t3, t4, t5, t6, t2, t8, cosR, sinR, t7, t9, t10, t12, t14) {
    switch (state0) {
      case 0:
      default:
                ...
                switch (state0) {
                  ...
                  case 8:
                    ...
                    if (typeof t10 !== "number")
                      throw $.iae(t10);
                    t14 = $.$$sub(t14, t3 * t10);
                    this._transformationMatrixPrivate.setTo$6(t1, t5, t9, t10, t12, t14);
                }
          }
        return this._transformationMatrixPrivate;
    }
  ...
  dispatchEvent$1: function(event) {
    ...
    if (event.get$captures() === true && !(ancestors == null)) {
      ...
      t2 = $.$$sub(t1.get$length(ancestors), 1);
      if (typeof t2 !== "number")
        return this.dispatchEvent$1$bailout(1, event, ancestors, t2, t1);
      i = t2;
      for (; i >= 0; --i)
        if ($.$$eq(event.get$stopsPropagation(), false) === true)
          t1.$index(ancestors, i)._dispatchEventInternal$4(event, this, t1.$index(ancestors, i), 1);
    }
    if ($.$$eq(event.get$stopsPropagation(), false) === true)
      this._dispatchEventInternal$4(event, this, this, 2);
    if (event.get$bubbles() === true && !(ancestors == null))
      for (t1 = $.getInterceptor$JSArrayJSString(ancestors), i = 0; $.CONSTANT.$lt(i, t1.get$length(ancestors)); ++i)
        if ($.$$eq(event.get$stopsPropagation(), false) === true)
          t1.$index(ancestors, i)._dispatchEventInternal$4(event, this, t1.$index(ancestors, i), 3);
  },
  dispatchEvent$1$bailout: function(state0, event, ancestors, t2, t1) {
    switch (state0) {
      case 0:
        if (event.get$captures() === true || event.get$bubbles() === true) {
          for (ancestor = this._parent, ancestors = null; !(ancestor == null); ancestor = ancestor.get$_parent())
...
$$.DisplayObjectContainer = {"": "InteractiveObject;",
    ...
    for (bottom = (-1/0), i = 0, left = (1/0), top = (1/0), right = (-1/0); i < t1; ++i) {
      ...
      if (t2 < left) {
        ...
        if (typeof left !== "number")
          return this.getBoundsTransformed$2$bailout(2, matrix, bottom, t1, i, left, rectangle, right, null, top, returnRectangle);
      }
      t2 = rectangle.get$top();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(3, matrix, bottom, t1, i, left, rectangle, right, t2, top, returnRectangle);
      if (t2 < top) {
        top = rectangle.get$top();
        if (typeof top !== "number")
          return this.getBoundsTransformed$2$bailout(4, matrix, bottom, t1, i, left, rectangle, right, null, top, returnRectangle);
      }
      t2 = rectangle.get$right();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(5, matrix, bottom, t1, i, left, rectangle, right, t2, top, returnRectangle);
      if (t2 > right) {
        right = rectangle.get$right();
        if (typeof right !== "number")
          return this.getBoundsTransformed$2$bailout(6, matrix, bottom, t1, i, left, rectangle, right, null, top, returnRectangle);
      }
      t2 = rectangle.get$bottom();
      if (typeof t2 !== "number")
        return this.getBoundsTransformed$2$bailout(7, matrix, bottom, t1, i, left, rectangle, right, t2, top, returnRectangle);
      if (t2 > bottom) {
        bottom = rectangle.get$bottom();
        if (typeof bottom !== "number")
          return this.getBoundsTransformed$2$bailout(8, matrix, bottom, t1, i, left, null, right, null, top, returnRectangle);
      }
    }
  ...
  getBoundsTransformed$2$bailout: function(state0, matrix, bottom, t1, i, left, rectangle, right, t2, top, returnRectangle) {
    switch (state0) {
      case 0:
        if (returnRectangle == null)
          returnRectangle = $.Rectangle$zero();
  ...
  hitTestInput$2: function(localX, localY) {
    ...
    for (i = this._children.length - 1, hit = null; i >= 0; --i) {
      ...
      if (child.get$visible() === true) {
        ...
        t1 = matrix.get$tx();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(2, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, matrix, i, t1);
        deltaX = localX - t1;
        t1 = matrix.get$ty();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(3, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, matrix, i, t1, deltaX);
        deltaY = localY - t1;
        t1 = matrix.get$d();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(4, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, matrix, i, t1, deltaX, deltaY);
        t1 *= deltaX;
        t5 = matrix.get$c();
        if (typeof t5 !== "number")
          return this.hitTestInput$2$bailout(5, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, matrix, i, t1, deltaX, deltaY, t5);
        t1 -= t5 * deltaY;
        t7 = matrix.get$det();
        if (typeof t7 !== "number")
          return this.hitTestInput$2$bailout(6, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, matrix, i, t1, deltaX, deltaY, null, t7);
        t7 = t1 / t7;
        t1 = matrix.get$a();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(7, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, matrix, i, t1, deltaX, deltaY, null, t7);
        t1 *= deltaY;
        t10 = matrix.get$b();
        if (typeof t10 !== "number")
          return this.hitTestInput$2$bailout(8, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, matrix, i, t1, deltaX, null, null, t7, t10);
        t1 -= t10 * deltaX;
        t12 = matrix.get$det();
        if (typeof t12 !== "number")
          return this.hitTestInput$2$bailout(9, localX, localY, $.CONSTANT4, hit, $.CONSTANT4, child, null, i, t1, null, null, null, t7, null, t12);
...
$$.TextField = {"": "InteractiveObject;_text,_textColor,_defaultTextFormat,_autoSize,_gridFitType,_type,_wordWrap,_background,_backgroundColor,_border,_borderColor,_textWidth,_textHeight,_linesText,_linesMetrics,_canvasRefreshPending,_canvasWidth,_canvasHeight,_canvas,_context,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_rotation,_transformationMatrixPrivate,_transformationMatrixRefresh,_alpha,_visible,_name,_parent,mask,_tmpMatrix,_tmpMatrixIdentity,_eventListenerLists",
  ...
  hitTestInput$2: function(localX, localY) {
    ...
    if (localX >= 0)
      if (localY >= 0) {
        ...
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout0(2, localX, localY, t1, $.CONSTANT4, $.CONSTANT4);
        if (localX < t1) {
          t1 = this._canvasHeight;
          if (typeof t1 !== "number")
            return this.hitTestInput$2$bailout0(3, null, localY, null, $.CONSTANT4, t1);
          t1 = localY < t1;
        } else
          t1 = false;
      } else
  ...
  hitTestInput$2$bailout0: function(state0, localX, localY, t3, t2, t1) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
    ...
    if (typeof b === "number") {
      ...
      if (typeof b === "number") {
        if (typeof a === "number")
          if (a === 0)
            return a + b;
        if ($.CONSTANT19.get$isNaN(b) === true)
          return b;
        return a;
      }
...
$.main = function() {
  var stage, textField1, textField2, textField3, textField4;
  ...
  textField2.set$text("Filet mignon leberkas pig pork chop biltong, short loin strip steak turkey brisket\r\nvenison. Pastrami venison pancetta, leberkas pork chop chicken prosciutto beef ribs\r\nbresaola kielbasa swine biltong capicola. Hamburger beef ribs ball tip drumstick salami\r\npig. Capicola pork loin shank, salami chicken hamburger tail. Sirloin spare ribs\r\nground round cow strip steak prosciutto swine bacon corned beef.");
  textField2.set$x(10);
  textField2.set$y(50);
  textField2.set$width(200);
  textField2.set$height(300);
  textField2.set$wordWrap(true);
  stage.addChild$1(textField2);
  ...
  textField3.set$text("Filet mignon leberkas pig pork chop biltong, short loin strip steak turkey brisket\r\nvenison. Pastrami venison pancetta, leberkas pork chop chicken prosciutto beef ribs\r\nbresaola kielbasa swine biltong capicola. Hamburger beef ribs ball tip drumstick salami\r\npig. Capicola pork loin shank, salami chicken hamburger tail. Sirloin spare ribs\r\nground round cow strip steak prosciutto swine bacon corned beef.");
  textField3.set$x(300);
  textField3.set$y(50);
  textField3.set$width(200);
  textField3.set$height(300);
  textField3.set$wordWrap(true);
  stage.addChild$1(textField3);
  ...
  textField4.set$text("Filet mignon leberkas pig pork chop biltong, short loin strip steak turkey brisket\r\nvenison. Pastrami venison pancetta, leberkas pork chop chicken prosciutto beef ribs\r\nbresaola kielbasa swine biltong capicola. Hamburger beef ribs ball tip drumstick salami\r\npig. Capicola pork loin shank, salami chicken hamburger tail. Sirloin spare ribs\r\nground round cow strip steak prosciutto swine bacon corned beef.");
  textField4.set$x(590);
  textField4.set$y(50);
  textField4.set$width(340);
  textField4.set$height(300);
  textField4.set$wordWrap(true);
  stage.addChild$1(textField4);
};
...
$.CONSTANT5 = new Isolate.$isolateProperties.EventStreamProvider("keypress");
...
$.CONSTANT8 = new Isolate.$isolateProperties.EventStreamProvider("touchcancel");
...
$.CONSTANT19 = new Isolate.$isolateProperties.JSDouble();
...
$.CONSTANT9 = new Isolate.$isolateProperties.EventStreamProvider("touchleave");
...
$.CONSTANT10 = new Isolate.$isolateProperties.EventStreamProvider("touchenter");
$.lazyPort = null;
...
$.Element_keyPressEvent = Isolate.$isolateProperties.CONSTANT5;
$.Element_keyUpEvent = Isolate.$isolateProperties.CONSTANT6;
$.Element_mouseDownEvent = Isolate.$isolateProperties.CONSTANT18;
$.Element_mouseMoveEvent = Isolate.$isolateProperties.CONSTANT16;
$.Element_mouseOutEvent = Isolate.$isolateProperties.CONSTANT15;
$.Element_mouseUpEvent = Isolate.$isolateProperties.CONSTANT17;
$.Element_touchCancelEvent = Isolate.$isolateProperties.CONSTANT8;
$.Element_touchEndEvent = Isolate.$isolateProperties.CONSTANT12;
$.Element_touchEnterEvent = Isolate.$isolateProperties.CONSTANT10;
$.Element_touchLeaveEvent = Isolate.$isolateProperties.CONSTANT9;
...
//@ sourceMappingURL=text.dart.js.map