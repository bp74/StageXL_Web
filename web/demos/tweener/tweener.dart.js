...
$$.DisplayObject = {"": ["_alpha>", "_parent>", "mask>"],
 ...
 dispatchEvent$1: function(event$) {
  ...
  if (event$.get$captures() === true && !(ancestors == null)) {
    ...
    if (typeof i !== 'number')
      return this.dispatchEvent$1$bailout(1, event$, i, ancestors);
    for (; i >= 0; --i)
...
$$.DisplayObjectContainer = {"": [],
 ...
 getBoundsTransformed$2: function(matrix, returnRectangle) {
  ...
  for (i = 0, left = (1/0), top$ = (1/0), right = (-1/0), bottom = (-1/0); i < t1; ++i) {
    ...
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(1, matrix, t1, i, left, top$, right, rectangle, bottom, t2, returnRectangle);
    if (t2 < left) {
      left = rectangle.get$left();
      if (typeof left !== 'number')
        return this.getBoundsTransformed$2$bailout(2, left, matrix, t1, i, top$, right, rectangle, bottom, returnRectangle);
    }
    t2 = rectangle.get$top();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(3, matrix, t1, left, i, top$, t2, right, rectangle, bottom, returnRectangle);
    if (t2 < top$) {
      top$ = rectangle.get$top();
      if (typeof top$ !== 'number')
        return this.getBoundsTransformed$2$bailout(4, matrix, t1, left, i, right, rectangle, bottom, top$, returnRectangle);
    }
    t2 = rectangle.get$right();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(5, matrix, t1, left, i, right, rectangle, bottom, top$, returnRectangle, t2);
    if (t2 > right) {
      right = rectangle.get$right();
      if (typeof right !== 'number')
        return this.getBoundsTransformed$2$bailout(6, matrix, t1, left, i, right, rectangle, bottom, top$, returnRectangle);
    }
    t2 = rectangle.get$bottom();
    if (typeof t2 !== 'number')
      return this.getBoundsTransformed$2$bailout(7, matrix, t1, left, i, right, rectangle, bottom, t2, top$, returnRectangle);
    if (t2 > bottom) {
