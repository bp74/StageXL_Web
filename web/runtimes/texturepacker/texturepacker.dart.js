...
$$.DelayedCall = {"": "Object;_liblib2$_action,_currentTime,_totalTime,_repeatCount",
  ...
  advanceTime$1: function(time) {
    ...
    while (true) {
      t1 = this._totalTime;
      if (typeof t1 !== "number")
        return this.advanceTime$1$bailout(2, 0, t1, newTime);
      if (newTime >= t1) {
        t2 = this._repeatCount;
        if (typeof t2 !== "number")
          return this.advanceTime$1$bailout(3, 0, t2, newTime, $.CONSTANT9);
        t2 = t2 > 0;
      } else
        t2 = false;
      if (!t2)
      ...
      if (typeof t1 !== "number")
        return this.advanceTime$1$bailout(4, 0, t1, newTime, $.CONSTANT9);
      this._repeatCount = t1 - 1;
      this._liblib2$_action$0();
      t3 = this._totalTime;
      if (typeof t3 !== "number")
        return this.advanceTime$1$bailout(5, 0, 0, newTime, $.CONSTANT9, t3);
      newTime -= t3;
    }
  ...
  advanceTime$1$bailout: function(state0, time, t1, newTime, t3, t4) {
    switch (state0) {
      case 0:
        t1 = this._currentTime;
      case 1:
        ...
        L0:
          while (true)
            switch (state0) {
              ...
              case 3:
                if (state0 === 3 || state0 === 0 && t3.$ge(newTime, t1) === true)
                  switch (state0) {
                    case 0:
                      t1 = this._repeatCount;
                    case 3:
...
$$.Tween = {"": "Object;_displayObject,_transitionFunction,_tweenProperties,_onStart,_onUpdate,_onComplete,_totalTime,_currentTime,_delay,_roundToInt,_started",
  ...
  animate$2: function(property, targetValue) {
    var t1 = $.CONSTANT5.indexOf$1(["x", "y", "pivotX", "pivotY", "scaleX", "scaleY", "rotation", "alpha"], property);
    if (typeof t1 !== "number")
...
$$.BitmapData = {"": "Object;_width,_height,_transparent,_element,_context,_frameMode,_frameOffsetX,_frameOffsetY,_frameX,_frameY,_frameWidth,_frameHeight",
  ...
  BitmapData$fromTextureAtlasFrame$1: function(textureAtlasFrame) {
    ...
    this._transparent = true;
    this._element = textureAtlasFrame.get$textureAtlas().get$imageElement();
...
$$.TextureAtlas = {"": "Object;_imageElement>,_frames>",
  ...
  getBitmapData$1: function($name) {
    ...
    while (true) {
      ...
      t3 = t1[i].get$name();
      if (typeof t3 !== "string")
        return this.getBitmapData$1$bailout(1, bitmapData, i, t3, $name);
      if (t3 === $name) {
        t1 = this._frames;
        if (i >= t1.length)
          throw $.ioore(i);
  ...
  getBitmapData$1$bailout: function(state0, bitmapData, i, t3, $name) {
    switch (state0) {
      case 0:
        bitmapData = null;
        i = 0;
...
$$.main_anon = {"": "Closure;",
  call$1: function(textureAtlas) {
    $.BitmapData_load("images/LevelupTextureAtlas.png").then$1(new $.main__anon());
    ...
    if (typeof b === "number") {
      ...
      if (typeof b === "number") {
        if (typeof a === "number")
          if (a === 0)
            return a + b;
        if ($.CONSTANT37.get$isNaN(b) === true)
          return b;
        return a;
      }
...
$.showLevelupAnimation = function(textureAtlas) {
  ...
  for (offset = 330, i = 0; i < 7; ++i, offset = offset0) {
    ...
    bitmap.set$pivotX($.$$div(bitmapData.get$width(), 2));
    bitmap.set$pivotY($.$$div(bitmapData.get$height(), 2));
    bitmap.set$x(offset + $.$$div(bitmapData.get$width(), 2));
    bitmap.set$y(150);
    bitmap.set$scaleX(0);
    bitmap.set$scaleY(0);
    bitmap.addTo$1($.stage);
    ...
    $.add($.renderLoop.get$juggler(), tween1);
    $.add($.renderLoop.get$juggler(), tween2);
...
$.CONSTANT37 = new Isolate.$isolateProperties.JSDouble();
