...
$$.JsonParser = {"": "Object;source>,listener>",
  ...
  parseTrue$1: function(position) {
    ...
    if (typeof t3 !== "number")
      return this.parseTrue$1$bailout(3, position, $.CONSTANT6, t2, t1, t3);
    if (t3 === 114) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseTrue$1$bailout(4, position, $.CONSTANT6, t2, t1, t3);
      if (t3 === 117) {
        t1 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t1 !== "number")
          return this.parseTrue$1$bailout(5, position, $.CONSTANT6, t1);
        t3 = !(t1 === 101);
        t1 = t3;
      } else
        t1 = true;
  ...
  parseFalse$1: function(position) {
    ...
    t3 = t2.charCodeAt$1(t1, position + 1);
    if (typeof t3 !== "number")
      return this.parseFalse$1$bailout(3, position, t1, $.CONSTANT6, t3, t2);
    if (t3 === 97) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseFalse$1$bailout(4, position, t1, $.CONSTANT6, t3, t2);
      if (t3 === 108) {
        t3 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t3 !== "number")
          return this.parseFalse$1$bailout(5, position, t1, $.CONSTANT6, t3, t2);
        if (t3 === 115) {
          t1 = t2.charCodeAt$1(t1, position + 4);
          if (typeof t1 !== "number")
            return this.parseFalse$1$bailout(6, position, $.CONSTANT6, t1);
          t3 = !(t1 === 101);
          t1 = t3;
        } else
          t1 = true;
  ...
  parseNull$1: function(position) {
    ...
    t3 = t2.charCodeAt$1(t1, position + 1);
    if (typeof t3 !== "number")
      return this.parseNull$1$bailout(3, position, $.CONSTANT6, t1, t3, t2);
    if (t3 === 117) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseNull$1$bailout(4, position, $.CONSTANT6, t1, t3, t2);
      if (t3 === 108) {
        t1 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t1 !== "number")
          return this.parseNull$1$bailout(5, position, $.CONSTANT6, t1);
        t3 = !(t1 === 108);
        t1 = t3;
      } else
        t1 = true;
...
$$.DelayedCall = {"": "Object;_currentTime,_totalTime,_repeatCount,_action",
  ...
  advanceTime$1: function(time) {
    ...
    while (true) {
      ...
      if (newTime >= t1) {
        ...
        if (typeof t2 !== "number")
          return this.advanceTime$1$bailout0(4, t2, newTime);
        t2 = t2 > 0;
      } else
        t2 = false;
      if (!t2)
  ...
  advanceTime$1$bailout0: function(state0, env0, env1) {
    ...
    switch (state0) {
      ...
      case 2:
        state0 = 0;
        newTime = $.getInterceptor$JSNumber(t1).operator$add$1(t1, time);
      default:
        L0:
          while (true)
            switch (state0) {
              ...
              case 5:
                state0 = 0;
                this._repeatCount = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, 1);
                this._action$0();
                t3 = this._totalTime;
              case 6:
                state0 = 0;
                newTime = $.getInterceptor$JSNumber(newTime).operator$sub$1(newTime, t3);
            }
        t1 = this._repeatCount;
      case 7:
...
$$.Tween = {"": "Object;_displayObject,_transitionFunction,_tweenProperties,_onStart,_onUpdate,_onComplete,_totalTime,_currentTime,_delay,_roundToInt,_started",
  ...
  animate$2: function(property, targetValue) {
    var t1 = $.CONSTANT2.indexOf$1(["x", "y", "pivotX", "pivotY", "scaleX", "scaleY", "rotation", "alpha"], property);
    if (typeof t1 !== "number")
    ...
    if (t1 < this._totalTime || !this._started) {
      ...
      if (this._currentTime >= 0) {
        ...
        for (t1 = $.getInterceptor$JSNumber(transition), i = 0; t2 = this._tweenProperties, i < t2.length; ++i) {
          ...
          t3 = tp.get$targetValue();
          t4 = t1.operator$mul$1(transition, $.getInterceptor$JSNumber(t3).operator$sub$1(t3, t2));
          value = $.getInterceptor$JSNumber(t2).operator$add$1(t2, t4);
          if (this._roundToInt)
...
$$.RenderLoop = {"": "Object;_juggler,_stages,_renderTime,_enterFrameIndex,_enterFrameEvent",
  ...
  _onAnimationFrame$1: function(currentTime) {
    ...
    if ($.CONSTANT6.get$isNaN(t1) === true)
...
$$.EventListenerList = {"": "Object;_eventDispatcher,_liblib3$_eventType,_liblib3$_list",
  ...
  add$2$bailout: function(state0, eventListener, useCapture, t1) {
    if ($.eqB(t1, "enterFrame") && this._liblib3$_list.length === 0) {
      t1 = $.get$_EventListenerListIndex_enterFrame();
      $.getInterceptor$JSArray(t1).add$1(t1, this);
    }
    $.CONSTANT2.add$1(this._liblib3$_list, $._EventListenerUseCapture$(eventListener, useCapture));
  ...
  get$_transformationMatrix: function() {
    ...
    if (this._transformationMatrixRefresh) {
      ...
      if ($.eqB(this._rotation, 0)) {
        ...
        t4 = this._x;
        t5 = this._pivotX;
        t5 = $.getInterceptor$JSNumber(t5).operator$mul$1(t5, t2);
        t5 = $.getInterceptor$JSNumber(t4).operator$sub$1(t4, t5);
        t4 = this._y;
        t6 = this._pivotY;
        t7 = this._scaleY;
        t7 = $.getInterceptor$JSNumber(t6).operator$mul$1(t6, t7);
        ...
        t1 = this._x;
        t2 = this._pivotX;
        t2 = $.getInterceptor$JSNumber(t2).operator$mul$1(t2, a);
        t2 = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, t2);
        t1 = this._pivotY;
        t1 = $.getInterceptor$JSNumber(t1).operator$mul$1(t1, c);
        tx = $.getInterceptor$JSNumber(t2).operator$sub$1(t2, t1);
        t1 = this._y;
        t2 = this._pivotX;
        t2 = $.getInterceptor$JSNumber(t2).operator$mul$1(t2, b);
        t2 = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, t2);
        t1 = this._pivotY;
        t1 = $.getInterceptor$JSNumber(t1).operator$mul$1(t1, d);
  ...
  hitTestInput$2: function(localX, localY) {
    ...
    for (i = this._children.length - 1, hit = null; i >= 0; --i) {
      ...
      if (child.get$visible() === true) {
        ...
        t1 = matrix.get$tx();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(2, i, localX, $.CONSTANT6, localY, hit, child, matrix, t1, $.CONSTANT6);
        deltaX = localX - t1;
        t1 = matrix.get$ty();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(3, i, deltaX, $.CONSTANT6, localX, localY, $.CONSTANT6, t1, child, matrix, hit);
        deltaY = localY - t1;
        t1 = matrix.get$d();
        if (typeof t1 !== "number")
          return this.hitTestInput$2$bailout(4, i, deltaX, $.CONSTANT6, deltaY, t1, $.CONSTANT6, localX, localY, child, matrix, hit);
        t1 *= deltaX;
        t5 = matrix.get$c();
        if (typeof t5 !== "number")
          return this.hitTestInput$2$bailout(5, deltaX, localY, $.CONSTANT6, deltaY, t1, t5, child, localX, hit, i, matrix, $.CONSTANT6);
        t1 -= t5 * deltaY;
        t7 = matrix.get$det();
        if (typeof t7 !== "number")
          return this.hitTestInput$2$bailout(6, deltaX, localY, $.CONSTANT6, deltaY, localX, child, t1, t7, hit, i, matrix, $.CONSTANT6);
        childX = t1 / t7;
        t7 = matrix.get$a();
        if (typeof t7 !== "number")
          return this.hitTestInput$2$bailout(7, deltaX, localY, $.CONSTANT6, deltaY, localX, child, childX, hit, i, t7, matrix, $.CONSTANT6);
        t7 *= deltaY;
        t9 = matrix.get$b();
        if (typeof t9 !== "number")
          return this.hitTestInput$2$bailout(8, deltaX, localY, $.CONSTANT6, localX, child, childX, hit, i, t7, t9, matrix, $.CONSTANT6);
        t7 -= t9 * deltaX;
        t11 = matrix.get$det();
        if (typeof t11 !== "number")
          return this.hitTestInput$2$bailout(9, i, localX, $.CONSTANT6, localY, $.CONSTANT6, t7, t11, child, childX, hit);
  ...
  render$1: function(renderState) {
    ...
    switch (this._frameMode) {
      ...
      case 2:
        ...
        t1.transform$6(0, -1, 1, 0, t2, $.getInterceptor$JSNumber(t3).operator$add$1(t3, t4));
        t2 = renderState.get$context();
        t1 = this._liblib3$_element;
        t5 = this._frameX;
        t6 = this._frameY;
        t7 = this._frameHeight;
        t8 = this._frameWidth;
        t2.drawImage$9(t1, t5, t6, t7, t8, 0, 0, t7, t8);
        break;
    }
  },
  renderClipped$2: function(renderState, clipRectangle) {
    var fLeft, fTop, t1, fRight, fBottom, t2, cLeft, cTop, cRight, cBottom, iLeft, iTop, iRight, iBottom, iOffsetX, iOffsetY, iWidth, iHeight;
    ...
    switch (this._frameMode) {
      ...
      case 1:
        ...
        fTop = this._frameY;
        t1 = this._frameWidth;
        fRight = $.getInterceptor$JSNumber(fLeft).operator$add$1(fLeft, t1);
        t1 = this._frameHeight;
        fBottom = $.getInterceptor$JSNumber(fTop).operator$add$1(fTop, t1);
        t1 = this._frameX;
        t2 = this._frameOffsetX;
        t2 = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, t2);
        t1 = clipRectangle.get$x();
        cLeft = $.getInterceptor$JSNumber(t2).operator$add$1(t2, t1);
        t1 = this._frameY;
        t2 = this._frameOffsetY;
        t2 = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, t2);
        t1 = clipRectangle.get$y();
        cTop = $.getInterceptor$JSNumber(t2).operator$add$1(t2, t1);
        t1 = clipRectangle.get$width();
        cRight = $.getInterceptor$JSNumber(cLeft).operator$add$1(cLeft, t1);
        t1 = clipRectangle.get$height();
        cBottom = $.getInterceptor$JSNumber(cTop).operator$add$1(cTop, t1);
        ...
        t1 = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, fLeft);
        iOffsetX = $.getInterceptor$JSNumber(t1).operator$add$1(t1, iLeft);
        t1 = this._frameOffsetY;
        t1 = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, fTop);
        iOffsetY = $.getInterceptor$JSNumber(t1).operator$add$1(t1, iTop);
        ...
        if ($.gtB(iWidth, 0) && $.gtB(iHeight, 0))
          renderState.get$context().drawImage$9(this._liblib3$_element, iLeft, iTop, iWidth, iHeight, iOffsetX, iOffsetY, iWidth, iHeight);
        break;
      case 2:
        fLeft = this._frameX;
        fTop = this._frameY;
        ...
        t2 = $.getInterceptor$JSNumber(t1).operator$add$1(t1, t2);
        t1 = clipRectangle.get$height();
        cLeft = $.getInterceptor$JSNumber(t2).operator$sub$1(t2, t1);
        t1 = this._frameY;
        t2 = this._frameOffsetX;
        t2 = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, t2);
        t1 = clipRectangle.get$x();
        ...
        t1 = this._frameOffsetY;
        t1 = $.getInterceptor$JSNumber(t1).operator$add$1(t1, fRight);
        iOffsetY = $.getInterceptor$JSNumber(t1).operator$sub$1(t1, iRight);
        ...
        if ($.gtB(iWidth, 0) && $.gtB(iHeight, 0)) {
          ...
          renderState.get$context().drawImage$9(this._liblib3$_element, iLeft, iTop, iHeight, iWidth, 0, 0, iHeight, iWidth);
        }
        break;
    }
  },
...
$$.TextureAtlas = {"": "Object;_imageElement>,_frames>",
  ...
  getBitmapData$1: function(name$) {
    ...
    while (true) {
      ...
      t3 = t1[i].get$name();
      if (typeof t3 !== "string")
        return this.getBitmapData$1$bailout(1, t3, i, name$, bitmapData);
      if (t3 === name$) {
        t1 = this._frames;
        if (i >= t1.length)
          throw $.ioore(i);
    ...
    if (bitmapData == null)
      throw $.$$throw($.ArgumentError$("TextureAtlasFrame not found: '" + name$ + "'"));
    return bitmapData;
  },
  getBitmapData$1$bailout: function(state0, env0, env1, env2, env3) {
    switch (state0) {
      case 1:
        bitmapData = env3;
        name$ = env2;
    ...
    switch (state0) {
      case 0:
        ...
        i = 0;
      case 1:
        var bitmapData, i, t1, t2, t3, name$;
        L0:
          while (true)
            switch (state0) {
              case 0:
...
$$.main_anon = {"": "Closure;",
  call$1: function(textureAtlas) {
    $.BitmapData_loadImage("images/LevelupTextureAtlas.png").then$1(new $.main__anon());
...
$$.TextureAtlas_load_onLoad = {"": "Closure;url_1,completer_2,textureAtlas_3,parseFrame_4",
  call$1: function(event$) {
    ...
    frames$ = t1.operator$index$1(data, "frames");
    meta = t1.operator$index$1(data, "meta");
    if (typeof frames$ === "object" && frames$ !== null && (frames$.constructor === Array || frames$.is$List())) {
      for (t1 = $.getInterceptor$JSArray(frames$).get$iterator(frames$), t2 = this.parseFrame_4; t1.moveNext$0() === true;) {
        t3 = t1.get$current();
        t2.call$2($.getInterceptor$JSStringJSArray(t3).operator$index$1(t3, "filename"), t3);
      }
      frames$ = frames$;
    }
    if (typeof frames$ === "object" && frames$ !== null && frames$.is$Map())
      for (t1 = frames$.get$keys(), t1 = $.getInterceptor$JSArray(t1).get$iterator(t1), t2 = this.parseFrame_4; t1.moveNext$0() === true;) {
        t3 = t1.get$current();
        t2.call$2(t3, frames$.operator$index$1(t3));
      }
    t1 = $._replaceFilename(this.url_1, $.getInterceptor$JSStringJSArray(meta).operator$index$1(meta, "image"));
...
$$.showLevelupAnimation_anon = {"": "Closure;bitmap_0",
  call$0: function() {
    return this.bitmap_0.removeFromParent$0();
  }
};

$$.showLevelupAnimation_anon0 = {"": "Closure;textureAtlas_1",
  call$0: function() {
    return $.showLevelupAnimation(this.textureAtlas_1);
  }
};
...
$.IsolateNatives_computeThisScript = function() {
  var t1, t2, src;
  for (t1 = $.CONSTANT2.get$iterator(document.getElementsByTagName('script')); t1.moveNext$0() === true;) {
    t2 = t1.get$current();
    src = t2 && t2.src;
    if (!(src == null)) {
...
$.Primitives_parseDouble = function(source, handleError) {
  ...
  if ($.CONSTANT6.get$isNaN(result) === true && !$.eqB(source, "NaN"))
    return handleError.call$1(source);
  return result;
};
...
$.listInsertRange$bailout = function(state0, receiver, start, length$, initialValue) {
  ...
  if (!(initialValue == null))
    for (i = start; i < t2; ++i)
      $.CONSTANT2.operator$indexSet$2(receiver, i, initialValue);
  $.CONSTANT2.set$length(receiver, t1);
};
...
$._FutureImpl__FutureImpl$wait = function(futures) {
  ...
  if (t2.get$isEmpty(futures) === true)
    return $.Future_Future$immediate($.CONSTANT23);
  completer = $.Completer_Completer();
        ...
        switch (state0) {
          ...
          case 2:
            ...
            for (; i >= srcStart; --i, --j) {
              ...
              if (i < 0 || i >= src.length)
                throw $.ioore(i);
              $.CONSTANT2.operator$indexSet$2(dst, j, src[i]);
            }
        }
      else
...
$.main = function() {
  ...
  $.TextureAtlas_load("images/LevelupTextureAtlas.json", "jsonarray").then$1(new $.main_anon());
};

$.showLevelupAnimation = function(textureAtlas) {
  var offset, i, bitmapData, bitmap, t1, t2, t3, tween1, tween2, t4, t5;
  for (offset = 330, i = 0; i < 7; ++i) {
    bitmapData = textureAtlas.getBitmapData$1("LevelUp" + $.S(i));
    bitmap = $.Bitmap$(bitmapData, "auto");
    t1 = bitmapData.get$width();
    bitmap.set$pivotX($.getInterceptor$JSNumber(t1).operator$div$1(t1, 2));
    t2 = bitmapData.get$height();
    bitmap.set$pivotY($.getInterceptor$JSNumber(t2).operator$div$1(t2, 2));
    t3 = bitmapData.get$width();
    t3 = $.getInterceptor$JSNumber(t3).operator$div$1(t3, 2);
    if (typeof t3 !== "number")
      throw $.iae(t3);
    bitmap.set$x(offset + t3);
    bitmap.set$y(150);
    bitmap.set$scaleX(0);
    bitmap.set$scaleY(0);
    bitmap.addTo$1($.stage);
    ...
    tween2.set$delay(2);
    tween2.set$onComplete(new $.showLevelupAnimation_anon(bitmap));
    t4 = $.renderLoop.get$juggler();
    $.getInterceptor$JSArray(t4).add$1(t4, tween1);
    t4 = $.renderLoop.get$juggler();
    $.getInterceptor$JSArray(t4).add$1(t4, tween2);
    t4 = offset + 5;
    t5 = bitmapData.get$width();
    if (typeof t5 !== "number")
      throw $.iae(t5);
    offset = t4 + t5;
  }
  $.renderLoop.get$juggler().delayCall$2(new $.showLevelupAnimation_anon0(textureAtlas), 3);
};
